# MedAgents — مواطن مستورد (medagents)

## التعريف
`MedAgents` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-health-medagents` من مصدره [https://github.com/MedAgents/MedAgents](https://github.com/MedAgents/MedAgents)، وصُنِّف أصلًا في
«وكلاء متخصصون (صحة)»، وأُسكِن في مجال `states-health`،
وتخصصه الدقيق **medical**، وخُصِّص له المكان
