# BioChatter — مواطن مستورد (biochatter)

## التعريف
`BioChatter` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-health-biochatter` من مصدره [https://github.com/biocypher/BioChatter](https://github.com/biocypher/BioChatter)، وصُنِّف أصلًا في
«وكلاء متخصصون (صحة)»، وأُسكِن في مجال `states-health`،
وتخصصه الدقيق **biomedical**، وخُصِّص له المكان
