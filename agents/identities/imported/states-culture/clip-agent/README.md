# CLIP-Agent — مواطن مستورد (clip-agent)

## التعريف
`CLIP-Agent` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-clip-agent` من مصدره [https://github.com/clip-agent/clip-agent](https://github.com/clip-agent/clip-agent)، وصُنِّف أصلًا في
«وكلاء متعددو الوسائط»، وأُسكِن في مجال `states-culture`،
وتخصصه الدقيق **vision-language**، وخُصِّص له المكان
