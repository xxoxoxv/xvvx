# هوية الوكيل المستورد: CLIP-Agent

## التعريف
- الاسم: CLIP-Agent
- المعرّف: imported-culture-clip-agent
- النوع: external_agent_framework
- المصدر: https://github.com/clip-agent/clip-agent
- التصنيف الأصلي: وكلاء متعددو الوسائط
- المكان المخصص: states/culture
- التخصص الدقيق: vision-language
