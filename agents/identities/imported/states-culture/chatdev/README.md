# ChatDev — مواطن مستورد (chatdev)

## التعريف
`ChatDev` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-chatdev` من مصدره [https://github.com/OpenBMB/ChatDev](https://github.com/OpenBMB/ChatDev)، وصُنِّف أصلًا في
