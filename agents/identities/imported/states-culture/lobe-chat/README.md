# Lobe Chat — مواطن مستورد (lobe-chat)

## التعريف
`Lobe Chat` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-lobe-chat` من مصدره [https://github.com/lobehub/lobe-chat](https://github.com/lobehub/lobe-chat)، وصُنِّف أصلًا في
