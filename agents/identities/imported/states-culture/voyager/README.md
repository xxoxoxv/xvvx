# Voyager (game) — مواطن مستورد (voyager)

## التعريف
`Voyager (game)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-voyager-2` من مصدره [https://github.com/MineDojo/Voyager](https://github.com/MineDojo/Voyager)، وصُنِّف أصلًا في
