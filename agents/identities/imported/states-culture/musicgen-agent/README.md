# MusicGen-Agent — مواطن مستورد (musicgen-agent)

## التعريف
`MusicGen-Agent` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-musicgen-agent` من مصدره [https://github.com/musicgen-agent/musicgen-agent](https://github.com/musicgen-agent/musicgen-agent)، وصُنِّف أصلًا في
«وكلاء متعددو الوسائط»، وأُسكِن في مجال `states-culture`،
وتخصصه الدقيق **music-generation**، وخُصِّص له المكان
