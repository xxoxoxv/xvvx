# هوية الوكيل المستورد: MusicGen-Agent

## التعريف
- الاسم: MusicGen-Agent
- المعرّف: imported-culture-musicgen-agent
- النوع: external_agent_framework
- المصدر: https://github.com/musicgen-agent/musicgen-agent
- التصنيف الأصلي: وكلاء متعددو الوسائط
- المكان المخصص: states/culture
- التخصص الدقيق: music-generation
