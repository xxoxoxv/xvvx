# TrinityClaw — مواطن مستورد (trinityclaw)

## التعريف
`TrinityClaw` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-trinityclaw` من مصدره [https://github.com/trinityclaw/trinityclaw](https://github.com/trinityclaw/trinityclaw)، وصُنِّف أصلًا في
