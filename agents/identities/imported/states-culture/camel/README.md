# CAMEL — مواطن مستورد (camel)

## التعريف
`CAMEL` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-camel` من مصدره [https://github.com/camel-ai/camel](https://github.com/camel-ai/camel)، وصُنِّف أصلًا في
