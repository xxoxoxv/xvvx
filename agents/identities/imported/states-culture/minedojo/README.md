# MineDojo (game) — مواطن مستورد (minedojo)

## التعريف
`MineDojo (game)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-minedojo-2` من مصدره [https://github.com/MineDojo/MineDojo](https://github.com/MineDojo/MineDojo)، وصُنِّف أصلًا في
