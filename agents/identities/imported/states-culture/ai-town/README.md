# AI-town — مواطن مستورد (ai-town)

## التعريف
`AI-town` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-ai-town` من مصدره [https://github.com/a16z-infra/ai-town](https://github.com/a16z-infra/ai-town)، وصُنِّف أصلًا في
