# هوية الوكيل المستورد: SeamlessM4T-Agent

## التعريف
- الاسم: SeamlessM4T-Agent
- المعرّف: imported-culture-seamlessm4t-agent
- النوع: external_agent_framework
- المصدر: https://github.com/seamless-m4t/seamless-m4t-agent
- التصنيف الأصلي: وكلاء متعددو الوسائط
- المكان المخصص: states/culture
- التخصص الدقيق: translation
