# SeamlessM4T-Agent — مواطن مستورد (seamlessm4t-agent)

## التعريف
`SeamlessM4T-Agent` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-seamlessm4t-agent` من مصدره [https://github.com/seamless-m4t/seamless-m4t-agent](https://github.com/seamless-m4t/seamless-m4t-agent)، وصُنِّف أصلًا في
«وكلاء متعددو الوسائط»، وأُسكِن في مجال `states-culture`،
وتخصصه الدقيق **translation**، وخُصِّص له المكان
