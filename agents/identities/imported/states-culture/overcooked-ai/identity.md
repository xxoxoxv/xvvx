# هوية الوكيل المستورد: Overcooked-AI (game)

## التعريف
- الاسم: Overcooked-AI (game)
- المعرّف: imported-culture-overcooked-ai-2
- النوع: external_agent_framework
- المصدر: https://github.com/HumanCompatibleAI/overcooked_ai
- التصنيف الأصلي: وكلاء ألعاب
- المكان المخصص: states/culture
- التخصص الدقيق: gaming
