# Overcooked-AI (game) — مواطن مستورد (overcooked-ai)

## التعريف
`Overcooked-AI (game)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-overcooked-ai-2` من مصدره [https://github.com/HumanCompatibleAI/overcooked_ai](https://github.com/HumanCompatibleAI/overcooked_ai)، وصُنِّف أصلًا في
«وكلاء ألعاب»، وأُسكِن في مجال `states-culture`،
وتخصصه الدقيق **gaming**، وخُصِّص له المكان
