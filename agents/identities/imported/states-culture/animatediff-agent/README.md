# AnimateDiff-Agent — مواطن مستورد (animatediff-agent)

## التعريف
`AnimateDiff-Agent` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-animatediff-agent` من مصدره [https://github.com/AnimateDiff/AnimateDiff-Agent](https://github.com/AnimateDiff/AnimateDiff-Agent)، وصُنِّف أصلًا في
«وكلاء متعددو الوسائط»، وأُسكِن في مجال `states-culture`،
وتخصصه الدقيق **animation**، وخُصِّص له المكان
