# هوية الوكيل المستورد: AnimateDiff-Agent

## التعريف
- الاسم: AnimateDiff-Agent
- المعرّف: imported-culture-animatediff-agent
- النوع: external_agent_framework
- المصدر: https://github.com/AnimateDiff/AnimateDiff-Agent
- التصنيف الأصلي: وكلاء متعددو الوسائط
- المكان المخصص: states/culture
- التخصص الدقيق: animation
