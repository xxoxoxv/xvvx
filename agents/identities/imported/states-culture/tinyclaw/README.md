# TinyClaw — مواطن مستورد (tinyclaw)

## التعريف
`TinyClaw` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-tinyclaw` من مصدره [https://github.com/tinyclaw/tinyclaw](https://github.com/tinyclaw/tinyclaw)، وصُنِّف أصلًا في
