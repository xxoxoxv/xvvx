# Neural MMO (game) — مواطن مستورد (neural-mmo)

## التعريف
`Neural MMO (game)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-neural-mmo-2` من مصدره [https://github.com/neuralmmo/neuralmmo](https://github.com/neuralmmo/neuralmmo)، وصُنِّف أصلًا في
