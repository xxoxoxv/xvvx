# TextWorld (Microsoft) — مواطن مستورد (textworld)

## التعريف
`TextWorld (Microsoft)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-textworld` من مصدره [https://github.com/microsoft/TextWorld](https://github.com/microsoft/TextWorld)، وصُنِّف أصلًا في
