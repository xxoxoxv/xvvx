# Video-LLaVA-Agent — مواطن مستورد (video-llava-agent)

## التعريف
`Video-LLaVA-Agent` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-video-llava-agent` من مصدره [https://github.com/video-llava/video-llava-agent](https://github.com/video-llava/video-llava-agent)، وصُنِّف أصلًا في
«وكلاء متعددو الوسائط»، وأُسكِن في مجال `states-culture`،
وتخصصه الدقيق **video-understanding**، وخُصِّص له المكان
