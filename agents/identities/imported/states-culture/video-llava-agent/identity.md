# هوية الوكيل المستورد: Video-LLaVA-Agent

## التعريف
- الاسم: Video-LLaVA-Agent
- المعرّف: imported-culture-video-llava-agent
- النوع: external_agent_framework
- المصدر: https://github.com/video-llava/video-llava-agent
- التصنيف الأصلي: وكلاء متعددو الوسائط
- المكان المخصص: states/culture
- التخصص الدقيق: video-understanding
