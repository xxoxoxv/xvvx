# هوية الوكيل المستورد: ImageBind-Agent

## التعريف
- الاسم: ImageBind-Agent
- المعرّف: imported-culture-imagebind-agent
- النوع: external_agent_framework
- المصدر: https://github.com/imagebind-agent/imagebind-agent
- التصنيف الأصلي: وكلاء متعددو الوسائط
- المكان المخصص: states/culture
- التخصص الدقيق: multimodal-binding
