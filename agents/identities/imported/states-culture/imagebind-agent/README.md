# ImageBind-Agent — مواطن مستورد (imagebind-agent)

## التعريف
`ImageBind-Agent` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-imagebind-agent` من مصدره [https://github.com/imagebind-agent/imagebind-agent](https://github.com/imagebind-agent/imagebind-agent)، وصُنِّف أصلًا في
«وكلاء متعددو الوسائط»، وأُسكِن في مجال `states-culture`،
وتخصصه الدقيق **multimodal-binding**، وخُصِّص له المكان
