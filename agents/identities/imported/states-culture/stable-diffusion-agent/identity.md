# هوية الوكيل المستورد: Stable-Diffusion-Agent

## التعريف
- الاسم: Stable-Diffusion-Agent
- المعرّف: imported-culture-stable-diffusion-agent
- النوع: external_agent_framework
- المصدر: https://github.com/stable-diffusion-agent/stable-diffusion-agent
- التصنيف الأصلي: وكلاء متعددو الوسائط
- المكان المخصص: states/culture
- التخصص الدقيق: image-generation
