# ClaudeClaw (conv) — مواطن مستورد (claudeclaw)

## التعريف
`ClaudeClaw (conv)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-claudeclaw` من مصدره [https://github.com/sbusso/claudeclaw](https://github.com/sbusso/claudeclaw)، وصُنِّف أصلًا في
