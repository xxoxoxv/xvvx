# هوية الوكيل المستورد: ClaudeClaw (conv)

## التعريف
- الاسم: ClaudeClaw (conv)
- المعرّف: imported-culture-claudeclaw
- النوع: external_agent_framework
- المصدر: https://github.com/sbusso/claudeclaw
- التصنيف الأصلي: وكلاء محادثة ومساعدين
- المكان المخصص: states/culture
- التخصص الدقيق: conversational
