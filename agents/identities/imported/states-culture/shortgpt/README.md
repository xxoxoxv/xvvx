# ShortGPT — مواطن مستورد (shortgpt)

## التعريف
`ShortGPT` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-shortgpt` من مصدره [https://github.com/RayVentura/ShortGPT](https://github.com/RayVentura/ShortGPT)، وصُنِّف أصلًا في
«وكلاء إبداعيين ومحاكاة»، وأُسكِن في مجال `states-culture`،
وتخصصه الدقيق **video-generation**، وخُصِّص له المكان
