# هوية الوكيل المستورد: ShortGPT

## التعريف
- الاسم: ShortGPT
- المعرّف: imported-culture-shortgpt
- النوع: external_agent_framework
- المصدر: https://github.com/RayVentura/ShortGPT
- التصنيف الأصلي: وكلاء إبداعيين ومحاكاة
- المكان المخصص: states/culture
- التخصص الدقيق: video-generation
