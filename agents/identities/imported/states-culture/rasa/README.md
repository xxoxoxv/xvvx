# Rasa — مواطن مستورد (rasa)

## التعريف
`Rasa` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-rasa` من مصدره [https://github.com/RasaHQ/rasa](https://github.com/RasaHQ/rasa)، وصُنِّف أصلًا في
«وكلاء صوت»، وأُسكِن في مجال `states-culture`،
وتخصصه الدقيق **conversational-ai**، وخُصِّص له المكان
