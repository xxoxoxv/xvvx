# هوية الوكيل المستورد: Rasa

## التعريف
- الاسم: Rasa
- المعرّف: imported-culture-rasa
- النوع: external_agent_framework
- المصدر: https://github.com/RasaHQ/rasa
- التصنيف الأصلي: وكلاء صوت
- المكان المخصص: states/culture
- التخصص الدقيق: conversational-ai
