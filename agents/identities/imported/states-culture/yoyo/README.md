# Yoyo — مواطن مستورد (yoyo)

## التعريف
`Yoyo` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-yoyo` من مصدره [https://github.com/yoyo-agent/yoyo](https://github.com/yoyo-agent/yoyo)، وصُنِّف أصلًا في
«وكلاء إبداعيين ومحاكاة»، وأُسكِن في مجال `states-culture`،
وتخصصه الدقيق **creative**، وخُصِّص له المكان
