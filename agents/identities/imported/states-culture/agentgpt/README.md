# AgentGPT — مواطن مستورد (agentgpt)

## التعريف
`AgentGPT` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-agentgpt` من مصدره [https://github.com/reworkd/AgentGPT](https://github.com/reworkd/AgentGPT)، وصُنِّف أصلًا في
