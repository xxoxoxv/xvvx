# Audiobox (Meta) — مواطن مستورد (audiobox)

## التعريف
`Audiobox (Meta)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-audiobox` من مصدره [https://github.com/facebookresearch/audiobox](https://github.com/facebookresearch/audiobox)، وصُنِّف أصلًا في
«وكلاء متعددو الوسائط»، وأُسكِن في مجال `states-culture`،
وتخصصه الدقيق **audio**، وخُصِّص له المكان
