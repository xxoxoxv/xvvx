# هوية الوكيل المستورد: Autonomous HR Chatbot

## التعريف
- الاسم: Autonomous HR Chatbot
- المعرّف: imported-culture-autonomous-hr-chatbot
- النوع: external_agent_framework
- المصدر: https://github.com/stepanogil/autonomous-hr-chatbot
- التصنيف الأصلي: وكلاء محادثة ومساعدين
- المكان المخصص: states/culture
- التخصص الدقيق: hr-assistant
