# Habitat (Meta) — مواطن مستورد (habitat)

## التعريف
`Habitat (Meta)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-habitat` من مصدره [https://github.com/facebookresearch/habitat-sim](https://github.com/facebookresearch/habitat-sim)، وصُنِّف أصلًا في
