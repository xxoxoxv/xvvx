# clawdbot (conv) — مواطن مستورد (clawdbot)

## التعريف
`clawdbot (conv)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-clawdbot` من مصدره [https://github.com/clawd-meme/clawdbot](https://github.com/clawd-meme/clawdbot)، وصُنِّف أصلًا في
