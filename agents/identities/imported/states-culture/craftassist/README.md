# CraftAssist (Facebook) — مواطن مستورد (craftassist)

## التعريف
`CraftAssist (Facebook)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-craftassist` من مصدره [https://github.com/facebookresearch/craftassist](https://github.com/facebookresearch/craftassist)، وصُنِّف أصلًا في
