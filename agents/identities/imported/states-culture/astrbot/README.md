# AstrBot — مواطن مستورد (astrbot)

## التعريف
`AstrBot` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-astrbot` من مصدره [https://github.com/AstrBot/AstrBot](https://github.com/AstrBot/AstrBot)، وصُنِّف أصلًا في
