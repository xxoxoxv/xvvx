# PicoClaw — مواطن مستورد (picoclaw)

## التعريف
`PicoClaw` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-picoclaw` من مصدره [https://github.com/picoclaw/picoclaw](https://github.com/picoclaw/picoclaw)، وصُنِّف أصلًا في
