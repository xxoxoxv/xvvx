# Khoj — مواطن مستورد (khoj)

## التعريف
`Khoj` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-khoj` من مصدره [https://github.com/khoj-ai/khoj](https://github.com/khoj-ai/khoj)، وصُنِّف أصلًا في
«وكلاء محادثة ومساعدين»، وأُسكِن في مجال `states-culture`،
وتخصصه الدقيق **personal-assistant**، وخُصِّص له المكان
