# MimiClaw — مواطن مستورد (mimiclaw)

## التعريف
`MimiClaw` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-mimiclaw` من مصدره [https://github.com/mimiclaw/mimiclaw](https://github.com/mimiclaw/mimiclaw)، وصُنِّف أصلًا في
