# OpenClaw (conv) — مواطن مستورد (openclaw)

## التعريف
`OpenClaw (conv)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-openclaw` من مصدره [https://github.com/openclaw/openclaw](https://github.com/openclaw/openclaw)، وصُنِّف أصلًا في
