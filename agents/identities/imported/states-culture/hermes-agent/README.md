# Hermes Agent (conv) — مواطن مستورد (hermes-agent)

## التعريف
`Hermes Agent (conv)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-hermes-agent` من مصدره [https://github.com/nousresearch/hermes-agent](https://github.com/nousresearch/hermes-agent)، وصُنِّف أصلًا في
«وكلاء محادثة ومساعدين»، وأُسكِن في مجال `states-culture`،
وتخصصه الدقيق **conversational**، وخُصِّص له المكان
