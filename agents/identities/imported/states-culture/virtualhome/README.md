# VirtualHome — مواطن مستورد (virtualhome)

## التعريف
`VirtualHome` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-virtualhome` من مصدره [https://github.com/xavierpuigf/virtualhome](https://github.com/xavierpuigf/virtualhome)، وصُنِّف أصلًا في
