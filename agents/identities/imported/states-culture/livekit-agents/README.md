# LiveKit Agents — مواطن مستورد (livekit-agents)

## التعريف
`LiveKit Agents` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-livekit-agents` من مصدره [https://github.com/livekit/agents](https://github.com/livekit/agents)، وصُنِّف أصلًا في
«وكلاء صوت»، وأُسكِن في مجال `states-culture`،
وتخصصه الدقيق **voice**، وخُصِّص له المكان
