# هوية الوكيل المستورد: OpenAgents Network

## التعريف
- الاسم: OpenAgents Network
- المعرّف: imported-culture-openagents-network
- النوع: external_agent_framework
- المصدر: https://github.com/openagents-network/openagents-network
- التصنيف الأصلي: وكلاء إبداعيين ومحاكاة
- المكان المخصص: states/culture
- التخصص الدقيق: simulation
