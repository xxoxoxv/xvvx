# Pipecat — مواطن مستورد (pipecat)

## التعريف
`Pipecat` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-pipecat` من مصدره [https://github.com/pipecat-ai/pipecat](https://github.com/pipecat-ai/pipecat)، وصُنِّف أصلًا في
