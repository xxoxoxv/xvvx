# NullClaw — مواطن مستورد (nullclaw)

## التعريف
`NullClaw` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-nullclaw` من مصدره [https://github.com/nullclaw/nullclaw](https://github.com/nullclaw/nullclaw)، وصُنِّف أصلًا في
