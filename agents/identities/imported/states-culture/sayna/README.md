# Sayna — مواطن مستورد (sayna)

## التعريف
`Sayna` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-sayna` من مصدره [https://github.com/sayna-ai/sayna](https://github.com/sayna-ai/sayna)، وصُنِّف أصلًا في
