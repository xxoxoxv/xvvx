# Jan.ai — مواطن مستورد (jan-ai)

## التعريف
`Jan.ai` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-jan-ai` من مصدره [https://github.com/janhq/jan](https://github.com/janhq/jan)، وصُنِّف أصلًا في
