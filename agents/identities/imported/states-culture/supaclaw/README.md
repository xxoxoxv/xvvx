# SupaClaw — مواطن مستورد (supaclaw)

## التعريف
`SupaClaw` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-supaclaw` من مصدره [https://github.com/supaclaw/supaclaw](https://github.com/supaclaw/supaclaw)، وصُنِّف أصلًا في
