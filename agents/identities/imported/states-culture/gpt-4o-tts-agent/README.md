# GPT-4o-TTS-Agent — مواطن مستورد (gpt-4o-tts-agent)

## التعريف
`GPT-4o-TTS-Agent` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-gpt-4o-tts-agent` من مصدره [https://github.com/gpt-4o-tts/gpt-4o-tts-agent](https://github.com/gpt-4o-tts/gpt-4o-tts-agent)، وصُنِّف أصلًا في
«وكلاء متعددو الوسائط»، وأُسكِن في مجال `states-culture`،
وتخصصه الدقيق **tts**، وخُصِّص له المكان
