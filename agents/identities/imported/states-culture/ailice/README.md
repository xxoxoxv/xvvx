# AIlice — مواطن مستورد (ailice)

## التعريف
`AIlice` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-culture-ailice` من مصدره [https://github.com/myshell-ai/AIlice](https://github.com/myshell-ai/AIlice)، وصُنِّف أصلًا في
