# Keep (devops) — مواطن مستورد (keep)

## التعريف
`Keep (devops)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-observability-keep-2` من مصدره [https://github.com/keephq/keep](https://github.com/keephq/keep)، وصُنِّف أصلًا في
«وكلاء DevOps والسحابة»، وأُسكِن في مجال `observability`،
وتخصصه الدقيق **alerting**، وخُصِّص له المكان
