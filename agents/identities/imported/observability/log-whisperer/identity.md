# هوية الوكيل المستورد: Log-Whisperer (devops)

## التعريف
- الاسم: Log-Whisperer (devops)
- المعرّف: imported-observability-log-whisperer-2
- النوع: external_agent_framework
- المصدر: https://github.com/log-whisperer/log-whisperer
- التصنيف الأصلي: وكلاء DevOps والسحابة
- المكان المخصص: observability
- التخصص الدقيق: log-analysis
