# Log-Whisperer (devops) — مواطن مستورد (log-whisperer)

## التعريف
`Log-Whisperer (devops)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-observability-log-whisperer-2` من مصدره [https://github.com/log-whisperer/log-whisperer](https://github.com/log-whisperer/log-whisperer)، وصُنِّف أصلًا في
«وكلاء DevOps والسحابة»، وأُسكِن في مجال `observability`،
وتخصصه الدقيق **log-analysis**، وخُصِّص له المكان
`observability` داخل بنية الدولة. لم يُنسخ كود مصدره
