# هوية الوكيل المستورد: Plotly-Dash-Agent

## التعريف
- الاسم: Plotly-Dash-Agent
- المعرّف: imported-science-plotly-dash-agent
- النوع: external_agent_framework
- المصدر: https://github.com/plotly-dash-agent/plotly-dash-agent
- التصنيف الأصلي: وكلاء تحليل بيانات
- المكان المخصص: states/science
- التخصص الدقيق: data-visualization
