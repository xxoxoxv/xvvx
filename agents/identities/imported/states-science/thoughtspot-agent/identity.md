# هوية الوكيل المستورد: ThoughtSpot-Agent

## التعريف
- الاسم: ThoughtSpot-Agent
- المعرّف: imported-science-thoughtspot-agent
- النوع: external_agent_framework
- المصدر: https://github.com/thoughtspot/thoughtspot-agent
- التصنيف الأصلي: وكلاء تحليل بيانات
- المكان المخصص: states/science
- التخصص الدقيق: data-analytics
