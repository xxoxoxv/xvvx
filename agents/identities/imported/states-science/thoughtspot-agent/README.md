# ThoughtSpot-Agent — مواطن مستورد (thoughtspot-agent)

## التعريف
`ThoughtSpot-Agent` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-science-thoughtspot-agent` من مصدره [https://github.com/thoughtspot/thoughtspot-agent](https://github.com/thoughtspot/thoughtspot-agent)، وصُنِّف أصلًا في
«وكلاء تحليل بيانات»، وأُسكِن في مجال `states-science`،
وتخصصه الدقيق **data-analytics**، وخُصِّص له المكان
