# STORM (Stanford) — مواطن مستورد (storm)

## التعريف
`STORM (Stanford)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-science-storm` من مصدره [https://github.com/stanford-oval/storm](https://github.com/stanford-oval/storm)، وصُنِّف أصلًا في
