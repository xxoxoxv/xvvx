# هوية الوكيل المستورد: BambooAI (analysis)

## التعريف
- الاسم: BambooAI (analysis)
- المعرّف: imported-science-bambooai
- النوع: external_agent_framework
- المصدر: https://github.com/rom1504/bambooai
- التصنيف الأصلي: وكلاء تحليل بيانات
- المكان المخصص: states/science
- التخصص الدقيق: data-analysis
