# BambooAI (analysis) — مواطن مستورد (bambooai)

## التعريف
`BambooAI (analysis)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-science-bambooai` من مصدره [https://github.com/rom1504/bambooai](https://github.com/rom1504/bambooai)، وصُنِّف أصلًا في
