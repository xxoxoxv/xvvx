# Protein-Agent — مواطن مستورد (protein-agent)

## التعريف
`Protein-Agent` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-science-protein-agent` من مصدره [https://github.com/protein-agent/protein-agent](https://github.com/protein-agent/protein-agent)، وصُنِّف أصلًا في
«وكلاء متخصصون (كيمياء)»، وأُسكِن في مجال `states-science`،
وتخصصه الدقيق **protein**، وخُصِّص له المكان
