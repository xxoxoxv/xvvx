# هوية الوكيل المستورد: Bio-SPICE

## التعريف
- الاسم: Bio-SPICE
- المعرّف: imported-science-bio-spice
- النوع: external_agent_framework
- المصدر: https://github.com/biospice/biospice
- التصنيف الأصلي: وكلاء متخصصون (كيمياء)
- المكان المخصص: states/science
- التخصص الدقيق: biochemistry
