# Bio-SPICE — مواطن مستورد (bio-spice)

## التعريف
`Bio-SPICE` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-science-bio-spice` من مصدره [https://github.com/biospice/biospice](https://github.com/biospice/biospice)، وصُنِّف أصلًا في
«وكلاء متخصصون (كيمياء)»، وأُسكِن في مجال `states-science`،
وتخصصه الدقيق **biochemistry**، وخُصِّص له المكان
