# PandasAI — مواطن مستورد (pandasai)

## التعريف
`PandasAI` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-science-pandasai` من مصدره [https://github.com/Sinaptik-ai/pandas-ai](https://github.com/Sinaptik-ai/pandas-ai)، وصُنِّف أصلًا في
