# AI Scientist — مواطن مستورد (ai-scientist)

## التعريف
`AI Scientist` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-science-ai-scientist` من مصدره [https://github.com/SakanaAI/AI-Scientist](https://github.com/SakanaAI/AI-Scientist)، وصُنِّف أصلًا في
