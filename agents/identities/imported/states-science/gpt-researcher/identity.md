# هوية الوكيل المستورد: GPT Researcher

## التعريف
- الاسم: GPT Researcher
- المعرّف: imported-science-gpt-researcher
- النوع: external_agent_framework
- المصدر: https://github.com/assafelovic/gpt-researcher
- التصنيف الأصلي: وكلاء بحث وأكاديميين
- المكان المخصص: states/science
- التخصص الدقيق: research
