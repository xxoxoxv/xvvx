# GPT Researcher — مواطن مستورد (gpt-researcher)

## التعريف
`GPT Researcher` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-science-gpt-researcher` من مصدره [https://github.com/assafelovic/gpt-researcher](https://github.com/assafelovic/gpt-researcher)، وصُنِّف أصلًا في
«وكلاء بحث وأكاديميين»، وأُسكِن في مجال `states-science`،
وتخصصه الدقيق **research**، وخُصِّص له المكان
