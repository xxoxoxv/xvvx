# DeepAnalyze — مواطن مستورد (deepanalyze)

## التعريف
`DeepAnalyze` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-science-deepanalyze` من مصدره [https://github.com/DeepAnalyze/DeepAnalyze](https://github.com/DeepAnalyze/DeepAnalyze)، وصُنِّف أصلًا في
