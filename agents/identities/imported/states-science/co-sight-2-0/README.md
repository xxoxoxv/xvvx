# Co-Sight 2.0 — مواطن مستورد (co-sight-2-0)

## التعريف
`Co-Sight 2.0` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-science-co-sight-2-0` من مصدره [https://github.com/ZTE/Co-Sight](https://github.com/ZTE/Co-Sight)، وصُنِّف أصلًا في
