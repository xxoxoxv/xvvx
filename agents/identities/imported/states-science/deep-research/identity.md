# هوية الوكيل المستورد: Deep Research

## التعريف
- الاسم: Deep Research
- المعرّف: imported-science-deep-research
- النوع: external_agent_framework
- المصدر: https://github.com/scienceaix/deepresearch
- التصنيف الأصلي: وكلاء بحث وأكاديميين
- المكان المخصص: states/science
- التخصص الدقيق: deep-research
