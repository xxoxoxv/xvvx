# Deep Research — مواطن مستورد (deep-research)

## التعريف
`Deep Research` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-science-deep-research` من مصدره [https://github.com/scienceaix/deepresearch](https://github.com/scienceaix/deepresearch)، وصُنِّف أصلًا في
«وكلاء بحث وأكاديميين»، وأُسكِن في مجال `states-science`،
وتخصصه الدقيق **deep-research**، وخُصِّص له المكان
