# ChemCrow — مواطن مستورد (chemcrow)

## التعريف
`ChemCrow` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-science-chemcrow` من مصدره [https://github.com/chemcrow/chemcrow](https://github.com/chemcrow/chemcrow)، وصُنِّف أصلًا في
«وكلاء متخصصون (كيمياء)»، وأُسكِن في مجال `states-science`،
وتخصصه الدقيق **chemistry**، وخُصِّص له المكان
