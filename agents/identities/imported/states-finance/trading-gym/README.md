# Trading-Gym — مواطن مستورد (trading-gym)

## التعريف
`Trading-Gym` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-finance-trading-gym` من مصدره [https://github.com/trading-gym/trading-gym](https://github.com/trading-gym/trading-gym)، وصُنِّف أصلًا في
«وكلاء متخصصون (تمويل)»، وأُسكِن في مجال `states-finance`،
وتخصصه الدقيق **trading**، وخُصِّص له المكان
`states/finance` داخل بنية الدولة. لم يُنسخ كود مصدره
