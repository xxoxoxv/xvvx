# FinGPT-Agent — مواطن مستورد (fingpt-agent)

## التعريف
`FinGPT-Agent` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-finance-fingpt-agent` من مصدره [https://github.com/FinGPT/FinGPT-Agent](https://github.com/FinGPT/FinGPT-Agent)، وصُنِّف أصلًا في
«وكلاء متخصصون (تمويل)»، وأُسكِن في مجال `states-finance`،
وتخصصه الدقيق **financial**، وخُصِّص له المكان
