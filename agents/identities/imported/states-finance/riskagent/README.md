# RiskAgent — مواطن مستورد (riskagent)

## التعريف
`RiskAgent` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-finance-riskagent` من مصدره [https://github.com/RiskAgent/RiskAgent](https://github.com/RiskAgent/RiskAgent)، وصُنِّف أصلًا في
«وكلاء متخصصون (تمويل)»، وأُسكِن في مجال `states-finance`،
وتخصصه الدقيق **risk**، وخُصِّص له المكان
