# هوية الوكيل المستورد: QuantAgent

## التعريف
- الاسم: QuantAgent
- المعرّف: imported-finance-quantagent
- النوع: external_agent_framework
- المصدر: https://github.com/QuantAgent/QuantAgent
- التصنيف الأصلي: وكلاء متخصصون (تمويل)
- المكان المخصص: states/finance
- التخصص الدقيق: quantitative
