# QuantAgent — مواطن مستورد (quantagent)

## التعريف
`QuantAgent` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-finance-quantagent` من مصدره [https://github.com/QuantAgent/QuantAgent](https://github.com/QuantAgent/QuantAgent)، وصُنِّف أصلًا في
«وكلاء متخصصون (تمويل)»، وأُسكِن في مجال `states-finance`،
وتخصصه الدقيق **quantitative**، وخُصِّص له المكان
