# Vanna — مواطن مستورد (vanna)

## التعريف
`Vanna` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-vanna` من مصدره [https://github.com/vanna-ai/vanna](https://github.com/vanna-ai/vanna)، وصُنِّف أصلًا في
