# Flowise — مواطن مستورد (flowise)

## التعريف
`Flowise` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-flowise` من مصدره [https://github.com/FlowiseAI/Flowise](https://github.com/FlowiseAI/Flowise)، وصُنِّف أصلًا في
