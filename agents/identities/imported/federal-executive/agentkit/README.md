# AgentKit — مواطن مستورد (agentkit)

## التعريف
`AgentKit` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-agentkit` من مصدره [https://github.com/holistic-ai/agentkit](https://github.com/holistic-ai/agentkit)، وصُنِّف أصلًا في
