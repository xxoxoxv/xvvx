# R2R — مواطن مستورد (r2r)

## التعريف
`R2R` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-r2r` من مصدره [https://github.com/SciPhi-AI/R2R](https://github.com/SciPhi-AI/R2R)، وصُنِّف أصلًا في
«أطر العمل الأساسية»، وأُسكِن في مجال `federal-executive`،
وتخصصه الدقيق **rag**، وخُصِّص له المكان
