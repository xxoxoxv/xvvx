# Dify Enterprise — مواطن مستورد (dify-enterprise)

## التعريف
`Dify Enterprise` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-dify-enterprise` من مصدره [https://github.com/langgenius/dify](https://github.com/langgenius/dify)، وصُنِّف أصلًا في
