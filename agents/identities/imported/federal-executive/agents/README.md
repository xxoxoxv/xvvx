# Agents (aiwaves-cn) — مواطن مستورد (agents)

## التعريف
`Agents (aiwaves-cn)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-agents` من مصدره [https://github.com/aiwaves-cn/agents](https://github.com/aiwaves-cn/agents)، وصُنِّف أصلًا في
