# Haystack — مواطن مستورد (haystack)

## التعريف
`Haystack` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-haystack` من مصدره [https://github.com/deepset-ai/haystack](https://github.com/deepset-ai/haystack)، وصُنِّف أصلًا في
