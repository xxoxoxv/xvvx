# TaskWeaver — مواطن مستورد (taskweaver)

## التعريف
`TaskWeaver` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-taskweaver` من مصدره [https://github.com/microsoft/TaskWeaver](https://github.com/microsoft/TaskWeaver)، وصُنِّف أصلًا في
«أطر العمل الأساسية»، وأُسكِن في مجال `federal-executive`،
وتخصصه الدقيق **code-framework**، وخُصِّص له المكان
