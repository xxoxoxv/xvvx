# هوية الوكيل المستورد: TaskWeaver

## التعريف
- الاسم: TaskWeaver
- المعرّف: imported-fedexecutive-taskweaver
- النوع: external_agent_framework
- المصدر: https://github.com/microsoft/TaskWeaver
- التصنيف الأصلي: أطر العمل الأساسية
- المكان المخصص: federal/executive
- التخصص الدقيق: code-framework
