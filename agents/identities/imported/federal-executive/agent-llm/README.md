# Agent-LLM — مواطن مستورد (agent-llm)

## التعريف
`Agent-LLM` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-agent-llm` من مصدره [https://github.com/Josh-XT/Agent-LLM](https://github.com/Josh-XT/Agent-LLM)، وصُنِّف أصلًا في
