# SimpleAIChat — مواطن مستورد (simpleaichat)

## التعريف
`SimpleAIChat` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-simpleaichat` من مصدره [https://github.com/minimaxir/simpleaichat](https://github.com/minimaxir/simpleaichat)، وصُنِّف أصلًا في
«أطر العمل الأساسية»، وأُسكِن في مجال `federal-executive`،
وتخصصه الدقيق **chat**، وخُصِّص له المكان
