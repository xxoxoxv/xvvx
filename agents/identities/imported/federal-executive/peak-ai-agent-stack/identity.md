# هوية الوكيل المستورد: Peak-AI-agent-stack

## التعريف
- الاسم: Peak-AI-agent-stack
- المعرّف: imported-fedexecutive-peak-ai-agent-stack
- النوع: external_agent_framework
- المصدر: https://github.com/dleerdefi/peak-ai-agent-stack
- التصنيف الأصلي: وكلاء محادثة ومساعدين
- المكان المخصص: federal/executive
- التخصص الدقيق: agent-stack
