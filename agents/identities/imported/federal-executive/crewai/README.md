# CrewAI — مواطن مستورد (crewai)

## التعريف
`CrewAI` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-crewai` من مصدره [https://github.com/joaomdmoura/crewAI](https://github.com/joaomdmoura/crewAI)، وصُنِّف أصلًا في
