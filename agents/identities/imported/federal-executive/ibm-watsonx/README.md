# IBM watsonx — مواطن مستورد (ibm-watsonx)

## التعريف
`IBM watsonx` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-ibm-watsonx` من مصدره [https://github.com/IBM/watsonx-ai](https://github.com/IBM/watsonx-ai)، وصُنِّف أصلًا في
