# Marvin — مواطن مستورد (marvin)

## التعريف
`Marvin` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-marvin` من مصدره [https://github.com/PrefectHQ/marvin](https://github.com/PrefectHQ/marvin)، وصُنِّف أصلًا في
