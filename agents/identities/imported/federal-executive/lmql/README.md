# LMQL — مواطن مستورد (lmql)

## التعريف
`LMQL` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-lmql` من مصدره [https://github.com/eth-sri/lmql](https://github.com/eth-sri/lmql)، وصُنِّف أصلًا في
«أطر العمل الأساسية»، وأُسكِن في مجال `federal-executive`،
وتخصصه الدقيق **query-language**، وخُصِّص له المكان
