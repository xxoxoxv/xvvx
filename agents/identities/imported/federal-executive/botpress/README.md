# Botpress — مواطن مستورد (botpress)

## التعريف
`Botpress` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-botpress` من مصدره [https://github.com/botpress/botpress](https://github.com/botpress/botpress)، وصُنِّف أصلًا في
