# LangChain — مواطن مستورد (langchain)

## التعريف
`LangChain` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-langchain` من مصدره [https://github.com/langchain-ai/langchain](https://github.com/langchain-ai/langchain)، وصُنِّف أصلًا في
