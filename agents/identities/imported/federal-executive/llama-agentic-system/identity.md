# هوية الوكيل المستورد: Llama Agentic System

## التعريف
- الاسم: Llama Agentic System
- المعرّف: imported-fedexecutive-llama-agentic-system
- النوع: external_agent_framework
- المصدر: https://github.com/meta-llama/llama-agentic-system
