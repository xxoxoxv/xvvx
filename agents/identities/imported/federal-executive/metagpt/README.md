# MetaGPT — مواطن مستورد (metagpt)

## التعريف
`MetaGPT` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-metagpt` من مصدره [https://github.com/geekan/MetaGPT](https://github.com/geekan/MetaGPT)، وصُنِّف أصلًا في
