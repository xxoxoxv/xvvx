# هوية الوكيل المستورد: Adala

## التعريف
- الاسم: Adala
- المعرّف: imported-fedexecutive-adala
- النوع: external_agent_framework
- المصدر: https://github.com/HumanSignal/Adala
- التصنيف الأصلي: أطر العمل الأساسية
- المكان المخصص: federal/executive
- التخصص الدقيق: data-labeling
