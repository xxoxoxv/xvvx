# Adala — مواطن مستورد (adala)

## التعريف
`Adala` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-adala` من مصدره [https://github.com/HumanSignal/Adala](https://github.com/HumanSignal/Adala)، وصُنِّف أصلًا في
«أطر العمل الأساسية»، وأُسكِن في مجال `federal-executive`،
وتخصصه الدقيق **data-labeling**، وخُصِّص له المكان
