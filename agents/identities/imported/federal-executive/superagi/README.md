# SuperAGI — مواطن مستورد (superagi)

## التعريف
`SuperAGI` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-superagi` من مصدره [https://github.com/TransformerOptimus/SuperAGI](https://github.com/TransformerOptimus/SuperAGI)، وصُنِّف أصلًا في
