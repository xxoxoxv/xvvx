# هوية الوكيل المستورد: Transformers Agents

## التعريف
- الاسم: Transformers Agents
- المعرّف: imported-fedexecutive-transformers-agents
- النوع: external_agent_framework
- المصدر: https://huggingface.co/docs/transformers/transformers_agents
- التصنيف الأصلي: أطر العمل الأساسية
- المكان المخصص: federal/executive
- التخصص الدقيق: model-framework
