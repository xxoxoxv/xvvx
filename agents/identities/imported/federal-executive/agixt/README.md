# AGiXT — مواطن مستورد (agixt)

## التعريف
`AGiXT` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-agixt` من مصدره [https://github.com/Josh-XT/AGiXT](https://github.com/Josh-XT/AGiXT)، وصُنِّف أصلًا في
