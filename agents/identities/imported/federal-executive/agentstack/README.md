# AgentStack — مواطن مستورد (agentstack)

## التعريف
`AgentStack` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-agentstack` من مصدره [https://github.com/AgentStack/AgentStack](https://github.com/AgentStack/AgentStack)، وصُنِّف أصلًا في
