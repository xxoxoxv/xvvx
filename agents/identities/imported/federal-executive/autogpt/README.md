# AutoGPT — مواطن مستورد (autogpt)

## التعريف
`AutoGPT` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-autogpt` من مصدره [https://github.com/Significant-Gravitas/AutoGPT](https://github.com/Significant-Gravitas/AutoGPT)، وصُنِّف أصلًا في
