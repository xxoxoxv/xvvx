# Coze Studio — مواطن مستورد (coze-studio)

## التعريف
`Coze Studio` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-coze-studio` من مصدره [https://github.com/coze-dev/coze-studio](https://github.com/coze-dev/coze-studio)، وصُنِّف أصلًا في
