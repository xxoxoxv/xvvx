# AgenticGoKit — مواطن مستورد (agenticgokit)

## التعريف
`AgenticGoKit` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-agenticgokit` من مصدره [https://github.com/agenticgokit/agenticgokit](https://github.com/agenticgokit/agenticgokit)، وصُنِّف أصلًا في
