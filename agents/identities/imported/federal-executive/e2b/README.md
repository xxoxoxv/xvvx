# e2b — مواطن مستورد (e2b)

## التعريف
`e2b` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-e2b` من مصدره [https://github.com/e2b-dev/e2b](https://github.com/e2b-dev/e2b)، وصُنِّف أصلًا في
«أطر العمل الأساسية»، وأُسكِن في مجال `federal-executive`،
وتخصصه الدقيق **sandbox**، وخُصِّص له المكان
