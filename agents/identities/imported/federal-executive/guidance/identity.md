# هوية الوكيل المستورد: Guidance

## التعريف
- الاسم: Guidance
- المعرّف: imported-fedexecutive-guidance
- النوع: external_agent_framework
- المصدر: https://github.com/guidance-ai/guidance
- التصنيف الأصلي: أطر العمل الأساسية
- المكان المخصص: federal/executive
- التخصص الدقيق: prompt-framework
