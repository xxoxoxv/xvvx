# YAML-agents — مواطن مستورد (yaml-agents)

## التعريف
`YAML-agents` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-yaml-agents` من مصدره [https://github.com/kyrolabs/yaml-agents](https://github.com/kyrolabs/yaml-agents)، وصُنِّف أصلًا في
