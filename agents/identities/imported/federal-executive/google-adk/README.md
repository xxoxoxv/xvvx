# Google ADK — مواطن مستورد (google-adk)

## التعريف
`Google ADK` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-google-adk` من مصدره [https://github.com/google/adk](https://github.com/google/adk)، وصُنِّف أصلًا في
