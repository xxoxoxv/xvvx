# XAgent — مواطن مستورد (xagent)

## التعريف
`XAgent` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-xagent` من مصدره [https://github.com/OpenBMB/XAgent](https://github.com/OpenBMB/XAgent)، وصُنِّف أصلًا في
