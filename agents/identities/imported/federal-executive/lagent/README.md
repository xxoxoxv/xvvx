# Lagent — مواطن مستورد (lagent)

## التعريف
`Lagent` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-lagent` من مصدره [https://github.com/InternLM/lagent](https://github.com/InternLM/lagent)، وصُنِّف أصلًا في
