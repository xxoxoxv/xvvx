# LlamaIndex — مواطن مستورد (llamaindex)

## التعريف
`LlamaIndex` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-llamaindex` من مصدره [https://github.com/run-llama/llama_index](https://github.com/run-llama/llama_index)، وصُنِّف أصلًا في
