# Semantic Kernel — مواطن مستورد (semantic-kernel)

## التعريف
`Semantic Kernel` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-semantic-kernel` من مصدره [https://github.com/microsoft/semantic-kernel](https://github.com/microsoft/semantic-kernel)، وصُنِّف أصلًا في
