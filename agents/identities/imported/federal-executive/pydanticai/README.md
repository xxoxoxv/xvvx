# PydanticAI — مواطن مستورد (pydanticai)

## التعريف
`PydanticAI` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-pydanticai` من مصدره [https://github.com/pydantic/pydantic-ai](https://github.com/pydantic/pydantic-ai)، وصُنِّف أصلًا في
