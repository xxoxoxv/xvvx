# Qwen-Agent — مواطن مستورد (qwen-agent)

## التعريف
`Qwen-Agent` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-qwen-agent` من مصدره [https://github.com/QwenLM/Qwen-Agent](https://github.com/QwenLM/Qwen-Agent)، وصُنِّف أصلًا في
