# هوية الوكيل المستورد: Outlines

## التعريف
- الاسم: Outlines
- المعرّف: imported-fedexecutive-outlines
- النوع: external_agent_framework
- المصدر: https://github.com/outlines-dev/outlines
- التصنيف الأصلي: أطر العمل الأساسية
- المكان المخصص: federal/executive
- التخصص الدقيق: structured-generation
