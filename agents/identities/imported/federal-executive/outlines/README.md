# Outlines — مواطن مستورد (outlines)

## التعريف
`Outlines` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-outlines` من مصدره [https://github.com/outlines-dev/outlines](https://github.com/outlines-dev/outlines)، وصُنِّف أصلًا في
«أطر العمل الأساسية»، وأُسكِن في مجال `federal-executive`،
وتخصصه الدقيق **structured-generation**، وخُصِّص له المكان
