# AgentPilot — مواطن مستورد (agentpilot)

## التعريف
`AgentPilot` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-agentpilot` من مصدره [https://github.com/jbexta/AgentPilot](https://github.com/jbexta/AgentPilot)، وصُنِّف أصلًا في
