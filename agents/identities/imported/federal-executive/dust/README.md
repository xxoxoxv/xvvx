# Dust — مواطن مستورد (dust)

## التعريف
`Dust` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-dust` من مصدره [https://github.com/dust-tt/dust](https://github.com/dust-tt/dust)، وصُنِّف أصلًا في
