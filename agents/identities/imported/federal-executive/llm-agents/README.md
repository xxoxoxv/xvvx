# LLM Agents — مواطن مستورد (llm-agents)

## التعريف
`LLM Agents` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-llm-agents` من مصدره [https://github.com/mpaepper/llm_agents](https://github.com/mpaepper/llm_agents)، وصُنِّف أصلًا في
