# AgentOS — مواطن مستورد (agentos)

## التعريف
`AgentOS` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-agentos` من مصدره [https://github.com/agentos-project/agentos](https://github.com/agentos-project/agentos)، وصُنِّف أصلًا في
