# هوية الوكيل المستورد: DSPy

## التعريف
- الاسم: DSPy
- المعرّف: imported-fedexecutive-dspy
- النوع: external_agent_framework
- المصدر: https://github.com/stanfordnlp/dspy
- التصنيف الأصلي: أطر العمل الأساسية
- المكان المخصص: federal/executive
- التخصص الدقيق: prompt-optimization
