# DSPy — مواطن مستورد (dspy)

## التعريف
`DSPy` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-dspy` من مصدره [https://github.com/stanfordnlp/dspy](https://github.com/stanfordnlp/dspy)، وصُنِّف أصلًا في
«أطر العمل الأساسية»، وأُسكِن في مجال `federal-executive`،
وتخصصه الدقيق **prompt-optimization**، وخُصِّص له المكان
