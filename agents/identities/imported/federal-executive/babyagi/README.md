# BabyAGI — مواطن مستورد (babyagi)

## التعريف
`BabyAGI` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-babyagi` من مصدره [https://github.com/yoheinakajima/babyagi](https://github.com/yoheinakajima/babyagi)، وصُنِّف أصلًا في
