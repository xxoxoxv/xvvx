# Agency Swarm — مواطن مستورد (agency-swarm)

## التعريف
`Agency Swarm` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-agency-swarm` من مصدره [https://github.com/VRSEN/agency-swarm](https://github.com/VRSEN/agency-swarm)، وصُنِّف أصلًا في
