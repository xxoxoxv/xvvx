# AgentForge — مواطن مستورد (agentforge)

## التعريف
`AgentForge` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-agentforge` من مصدره [https://github.com/DataBassGit/AgentForge](https://github.com/DataBassGit/AgentForge)، وصُنِّف أصلًا في
