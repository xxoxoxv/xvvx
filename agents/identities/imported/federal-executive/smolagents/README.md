# Smolagents — مواطن مستورد (smolagents)

## التعريف
`Smolagents` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-smolagents` من مصدره [https://github.com/huggingface/smolagents](https://github.com/huggingface/smolagents)، وصُنِّف أصلًا في
