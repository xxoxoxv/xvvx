# Agno (Phidata) — مواطن مستورد (agno)

## التعريف
`Agno (Phidata)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-agno` من مصدره [https://github.com/phidatahq/phidata](https://github.com/phidatahq/phidata)، وصُنِّف أصلًا في
