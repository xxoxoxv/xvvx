# OpenHands — مواطن مستورد (openhands)

## التعريف
`OpenHands` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-openhands` من مصدره [https://github.com/All-Hands-AI/OpenHands](https://github.com/All-Hands-AI/OpenHands)، وصُنِّف أصلًا في
