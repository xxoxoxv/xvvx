# AG2 — مواطن مستورد (ag2)

## التعريف
`AG2` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-ag2` من مصدره [https://github.com/ag2ai/ag2](https://github.com/ag2ai/ag2)، وصُنِّف أصلًا في
