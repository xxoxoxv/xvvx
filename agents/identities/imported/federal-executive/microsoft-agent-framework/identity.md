# هوية الوكيل المستورد: Microsoft Agent Framework (enterprise)

## التعريف
- الاسم: Microsoft Agent Framework (enterprise)
- المعرّف: imported-fedexecutive-microsoft-agent-framework-2
- النوع: external_agent_framework
- المصدر: https://github.com/microsoft/agent-framework
- التصنيف الأصلي: وكلاء مؤسسيين
- المكان المخصص: federal/executive
- التخصص الدقيق: enterprise
