# WrenAI — مواطن مستورد (wrenai)

## التعريف
`WrenAI` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-wrenai` من مصدره [https://github.com/Canner/WrenAI](https://github.com/Canner/WrenAI)، وصُنِّف أصلًا في
