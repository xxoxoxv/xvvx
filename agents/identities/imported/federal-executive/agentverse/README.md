# AgentVerse — مواطن مستورد (agentverse)

## التعريف
`AgentVerse` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-agentverse` من مصدره [https://github.com/OpenBMB/AgentVerse](https://github.com/OpenBMB/AgentVerse)، وصُنِّف أصلًا في
