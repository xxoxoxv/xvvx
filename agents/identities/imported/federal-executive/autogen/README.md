# AutoGen — مواطن مستورد (autogen)

## التعريف
`AutoGen` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-autogen` من مصدره [https://github.com/microsoft/autogen](https://github.com/microsoft/autogen)، وصُنِّف أصلًا في
