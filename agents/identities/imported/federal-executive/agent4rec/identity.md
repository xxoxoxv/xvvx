# هوية الوكيل المستورد: Agent4Rec

## التعريف
- الاسم: Agent4Rec
- المعرّف: imported-fedexecutive-agent4rec
- النوع: external_agent_framework
- المصدر: https://github.com/LehengTHU/Agent4Rec
- التصنيف الأصلي: أطر العمل الأساسية
- المكان المخصص: federal/executive
- التخصص الدقيق: recommendation
