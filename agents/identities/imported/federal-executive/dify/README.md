# Dify — مواطن مستورد (dify)

## التعريف
`Dify` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-dify` من مصدره [https://github.com/langgenius/dify](https://github.com/langgenius/dify)، وصُنِّف أصلًا في
