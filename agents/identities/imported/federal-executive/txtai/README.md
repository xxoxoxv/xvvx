# txtai — مواطن مستورد (txtai)

## التعريف
`txtai` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-txtai` من مصدره [https://github.com/neuml/txtai](https://github.com/neuml/txtai)، وصُنِّف أصلًا في
