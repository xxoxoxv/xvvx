# هوية الوكيل المستورد: Dataherald

## التعريف
- الاسم: Dataherald
- المعرّف: imported-fedexecutive-dataherald
- النوع: external_agent_framework
- المصدر: https://github.com/Dataherald/dataherald
- التصنيف الأصلي: أطر العمل الأساسية
- المكان المخصص: federal/executive
- التخصص الدقيق: data-framework
