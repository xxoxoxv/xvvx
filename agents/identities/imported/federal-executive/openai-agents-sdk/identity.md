# هوية الوكيل المستورد: OpenAI Agents SDK

## التعريف
- الاسم: OpenAI Agents SDK
- المعرّف: imported-fedexecutive-openai-agents-sdk
- النوع: external_agent_framework
- المصدر: https://github.com/openai/openai-agents-python
