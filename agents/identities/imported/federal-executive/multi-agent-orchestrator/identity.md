# هوية الوكيل المستورد: Multi-Agent Orchestrator

## التعريف
- الاسم: Multi-Agent Orchestrator
- المعرّف: imported-fedexecutive-multi-agent-orchestrator
- النوع: external_agent_framework
- المصدر: https://github.com/ParthivPandya/multi-agent-orchestrator
