# Hermes Agent — مواطن مستورد (hermes-agent)

## التعريف
`Hermes Agent` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-hermes-agent` من مصدره [https://github.com/nousresearch/hermes-agent](https://github.com/nousresearch/hermes-agent)، وصُنِّف أصلًا في
