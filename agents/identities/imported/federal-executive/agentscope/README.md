# AgentScope — مواطن مستورد (agentscope)

## التعريف
`AgentScope` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-agentscope` من مصدره [https://github.com/modelscope/agentscope](https://github.com/modelscope/agentscope)، وصُنِّف أصلًا في
«أطر العمل الأساسية»، وأُسكِن في مجال `federal-executive`،
وتخصصه الدقيق **multi-agent**، وخُصِّص له المكان
