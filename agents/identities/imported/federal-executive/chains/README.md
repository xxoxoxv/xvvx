# Chains (Cohere) — مواطن مستورد (chains)

## التعريف
`Chains (Cohere)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-fedexecutive-chains` من مصدره [https://github.com/cohere-ai/chains](https://github.com/cohere-ai/chains)، وصُنِّف أصلًا في
