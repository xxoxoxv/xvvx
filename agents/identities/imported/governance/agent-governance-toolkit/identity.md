# هوية الوكيل المستورد: Agent Governance Toolkit (Microsoft)

## التعريف
- الاسم: Agent Governance Toolkit (Microsoft)
- المعرّف: imported-governance-agent-governance-toolkit
- النوع: external_agent_framework
- المصدر: https://github.com/microsoft/agent-governance-toolkit
- التصنيف الأصلي: أمان وحوكمة
- المكان المخصص: governance
- التخصص الدقيق: governance
