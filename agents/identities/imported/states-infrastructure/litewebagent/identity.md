# هوية الوكيل المستورد: LiteWebAgent

## التعريف
- الاسم: LiteWebAgent
- المعرّف: imported-infrastructure-litewebagent
- النوع: external_agent_framework
- المصدر: https://github.com/LiteWebAgent/LiteWebAgent
- التصنيف الأصلي: وكلاء تصفح وأتمتة
- المكان المخصص: states/infrastructure
- التخصص الدقيق: browser-automation
