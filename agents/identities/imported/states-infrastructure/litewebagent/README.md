# LiteWebAgent — مواطن مستورد (litewebagent)

## التعريف
`LiteWebAgent` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-litewebagent` من مصدره [https://github.com/LiteWebAgent/LiteWebAgent](https://github.com/LiteWebAgent/LiteWebAgent)، وصُنِّف أصلًا في
«وكلاء تصفح وأتمتة»، وأُسكِن في مجال `states-infrastructure`،
وتخصصه الدقيق **browser-automation**، وخُصِّص له المكان
