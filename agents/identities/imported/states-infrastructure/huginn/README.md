# Huginn (workflow) — مواطن مستورد (huginn)

## التعريف
`Huginn (workflow)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-huginn-2` من مصدره [https://github.com/huginn/huginn](https://github.com/huginn/huginn)، وصُنِّف أصلًا في
