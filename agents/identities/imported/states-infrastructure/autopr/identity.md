# هوية الوكيل المستورد: AutoPR

## التعريف
- الاسم: AutoPR
- المعرّف: imported-infrastructure-autopr
- النوع: external_agent_framework
- المصدر: https://github.com/irgolic/AutoPR
- التصنيف الأصلي: وكلاء برمجيين وتطوير
- المكان المخصص: states/infrastructure
- التخصص الدقيق: pr-automation
