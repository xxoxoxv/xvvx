# AutoPR — مواطن مستورد (autopr)

## التعريف
`AutoPR` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-autopr` من مصدره [https://github.com/irgolic/AutoPR](https://github.com/irgolic/AutoPR)، وصُنِّف أصلًا في
«وكلاء برمجيين وتطوير»، وأُسكِن في مجال `states-infrastructure`،
وتخصصه الدقيق **pr-automation**، وخُصِّص له المكان
