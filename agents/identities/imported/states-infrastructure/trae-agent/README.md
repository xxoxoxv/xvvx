# trae-agent (ByteDance) — مواطن مستورد (trae-agent)

## التعريف
`trae-agent (ByteDance)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-trae-agent` من مصدره [https://github.com/bytedance/trae-agent](https://github.com/bytedance/trae-agent)، وصُنِّف أصلًا في
