# هوية الوكيل المستورد: trae-agent (ByteDance)

## التعريف
- الاسم: trae-agent (ByteDance)
- المعرّف: imported-infrastructure-trae-agent
- النوع: external_agent_framework
- المصدر: https://github.com/bytedance/trae-agent
