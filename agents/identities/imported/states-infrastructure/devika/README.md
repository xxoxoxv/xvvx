# Devika — مواطن مستورد (devika)

## التعريف
`Devika` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-devika` من مصدره [https://github.com/stitionai/devika](https://github.com/stitionai/devika)، وصُنِّف أصلًا في
