# BambooAI — مواطن مستورد (bambooai)

## التعريف
`BambooAI` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-bambooai` من مصدره [https://github.com/rom1504/bambooai](https://github.com/rom1504/bambooai)، وصُنِّف أصلًا في
«وكلاء برمجيين وتطوير»، وأُسكِن في مجال `states-infrastructure`،
وتخصصه الدقيق **data-analysis**، وخُصِّص له المكان
