# هوية الوكيل المستورد: open-swe

## التعريف
- الاسم: open-swe
- المعرّف: imported-infrastructure-open-swe
- النوع: external_agent_framework
- المصدر: https://github.com/langchain-ai/open-swe
- التصنيف الأصلي: وكلاء برمجيين وتطوير
- المكان المخصص: states/infrastructure
- التخصص الدقيق: swe-automation
