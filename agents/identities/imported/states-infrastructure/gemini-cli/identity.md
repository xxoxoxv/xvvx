# هوية الوكيل المستورد: Gemini CLI (Google)

## التعريف
- الاسم: Gemini CLI (Google)
- المعرّف: imported-infrastructure-gemini-cli
- النوع: external_agent_framework
- المصدر: https://github.com/google-gemini/gemini-cli
