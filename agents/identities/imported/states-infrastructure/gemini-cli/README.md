# Gemini CLI (Google) — مواطن مستورد (gemini-cli)

## التعريف
`Gemini CLI (Google)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-gemini-cli` من مصدره [https://github.com/google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli)، وصُنِّف أصلًا في
