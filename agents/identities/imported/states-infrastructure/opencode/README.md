# OpenCode — مواطن مستورد (opencode)

## التعريف
`OpenCode` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-opencode` من مصدره [https://github.com/opencode-ai/opencode](https://github.com/opencode-ai/opencode)، وصُنِّف أصلًا في
