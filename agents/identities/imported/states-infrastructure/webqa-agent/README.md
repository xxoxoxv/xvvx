# WebQA-Agent — مواطن مستورد (webqa-agent)

## التعريف
`WebQA-Agent` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-webqa-agent` من مصدره [https://github.com/WebQA-Agent/WebQA-Agent](https://github.com/WebQA-Agent/WebQA-Agent)، وصُنِّف أصلًا في
«وكلاء تصفح وأتمتة»، وأُسكِن في مجال `states-infrastructure`،
وتخصصه الدقيق **web-qa**، وخُصِّص له المكان
