# UFO (Microsoft) — مواطن مستورد (ufo)

## التعريف
`UFO (Microsoft)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-ufo` من مصدره [https://github.com/microsoft/UFO](https://github.com/microsoft/UFO)، وصُنِّف أصلًا في
