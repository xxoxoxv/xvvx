# هوية الوكيل المستورد: GitHub Copilot CLI

## التعريف
- الاسم: GitHub Copilot CLI
- المعرّف: imported-infrastructure-github-copilot-cli
- النوع: external_agent_framework
- المصدر: https://github.com/github/copilot-cli
