# ToRA — مواطن مستورد (tora)

## التعريف
`ToRA` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-tora` من مصدره [https://github.com/microsoft/ToRA](https://github.com/microsoft/ToRA)، وصُنِّف أصلًا في
