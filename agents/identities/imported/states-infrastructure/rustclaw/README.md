# RustClaw — مواطن مستورد (rustclaw)

## التعريف
`RustClaw` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-rustclaw` من مصدره [https://github.com/RustClawBot/rustclaw](https://github.com/RustClawBot/rustclaw)، وصُنِّف أصلًا في
