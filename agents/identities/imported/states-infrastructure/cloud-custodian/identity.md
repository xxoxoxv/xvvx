# هوية الوكيل المستورد: Cloud-Custodian (devops)

## التعريف
- الاسم: Cloud-Custodian (devops)
- المعرّف: imported-infrastructure-cloud-custodian-2
- النوع: external_agent_framework
- المصدر: https://github.com/cloud-custodian/cloud-custodian
- التصنيف الأصلي: وكلاء DevOps والسحابة
- المكان المخصص: states/infrastructure
- التخصص الدقيق: cloud-governance
