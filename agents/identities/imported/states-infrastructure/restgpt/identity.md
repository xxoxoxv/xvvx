# هوية الوكيل المستورد: RestGPT

## التعريف
- الاسم: RestGPT
- المعرّف: imported-infrastructure-restgpt
- النوع: external_agent_framework
- المصدر: https://github.com/Yifan-Song793/RestGPT
- التصنيف الأصلي: وكلاء تصفح وأتمتة
- المكان المخصص: states/infrastructure
- التخصص الدقيق: api-automation
