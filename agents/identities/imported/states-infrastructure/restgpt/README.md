# RestGPT — مواطن مستورد (restgpt)

## التعريف
`RestGPT` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-restgpt` من مصدره [https://github.com/Yifan-Song793/RestGPT](https://github.com/Yifan-Song793/RestGPT)، وصُنِّف أصلًا في
«وكلاء تصفح وأتمتة»، وأُسكِن في مجال `states-infrastructure`،
وتخصصه الدقيق **api-automation**، وخُصِّص له المكان
