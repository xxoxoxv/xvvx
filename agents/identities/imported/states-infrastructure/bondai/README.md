# BondAI — مواطن مستورد (bondai)

## التعريف
`BondAI` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-bondai` من مصدره [https://github.com/knowsuchagency/bondai](https://github.com/knowsuchagency/bondai)، وصُنِّف أصلًا في
