# CodeGPT — مواطن مستورد (codegpt)

## التعريف
`CodeGPT` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-codegpt` من مصدره [https://github.com/CodeGPT-org/CodeGPT](https://github.com/CodeGPT-org/CodeGPT)، وصُنِّف أصلًا في
