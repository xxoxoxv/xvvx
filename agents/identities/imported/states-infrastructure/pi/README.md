...
## التعريف
`Pi` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-pi` من مصدره [https://github.com/pi-ai/pi](https://github.com/pi-ai/pi)، وصُنِّف أصلًا في
