# OpenWorker — مواطن مستورد (openworker)

## التعريف
`OpenWorker` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-openworker` من مصدره [https://github.com/andrewyng/openworker](https://github.com/andrewyng/openworker)، وصُنِّف أصلًا في
«وكلاء تصفح وأتمتة»، وأُسكِن في مجال `states-infrastructure`،
وتخصصه الدقيق **automation**، وخُصِّص له المكان
