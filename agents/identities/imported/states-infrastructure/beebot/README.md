# BeeBot — مواطن مستورد (beebot)

## التعريف
`BeeBot` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-beebot` من مصدره [https://github.com/AI-BeeBot/beeBot](https://github.com/AI-BeeBot/beeBot)، وصُنِّف أصلًا في
