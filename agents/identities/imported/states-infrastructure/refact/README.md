# Refact — مواطن مستورد (refact)

## التعريف
`Refact` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-refact` من مصدره [https://github.com/smallcloudai/refact](https://github.com/smallcloudai/refact)، وصُنِّف أصلًا في
