# هوية الوكيل المستورد: DevOps-Monkey (devops)

## التعريف
- الاسم: DevOps-Monkey (devops)
- المعرّف: imported-infrastructure-devops-monkey-2
- النوع: external_agent_framework
- المصدر: https://github.com/devops-monkey/devops-monkey
- التصنيف الأصلي: وكلاء DevOps والسحابة
- المكان المخصص: states/infrastructure
- التخصص الدقيق: devops
