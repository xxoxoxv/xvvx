# Blinky — مواطن مستورد (blinky)

## التعريف
`Blinky` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-blinky` من مصدره [https://github.com/maximz/blinky](https://github.com/maximz/blinky)، وصُنِّف أصلًا في
