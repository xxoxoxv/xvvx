# bolt.diy — مواطن مستورد (bolt-diy)

## التعريف
`bolt.diy` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-bolt-diy` من مصدره [https://github.com/bolt-foundry/bolt.diy](https://github.com/bolt-foundry/bolt.diy)، وصُنِّف أصلًا في
