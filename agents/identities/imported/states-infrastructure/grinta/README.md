# Grinta — مواطن مستورد (grinta)

## التعريف
`Grinta` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-grinta` من مصدره [https://github.com/grinta-ai/grinta](https://github.com/grinta-ai/grinta)، وصُنِّف أصلًا في
