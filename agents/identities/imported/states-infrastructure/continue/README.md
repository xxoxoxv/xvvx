# Continue — مواطن مستورد (continue)

## التعريف
`Continue` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-continue` من مصدره [https://github.com/continuedev/continue](https://github.com/continuedev/continue)، وصُنِّف أصلًا في
«وكلاء برمجيين وتطوير»، وأُسكِن في مجال `states-infrastructure`،
وتخصصه الدقيق **ide-assistant**، وخُصِّص له المكان
