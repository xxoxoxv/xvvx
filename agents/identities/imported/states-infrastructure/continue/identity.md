# هوية الوكيل المستورد: Continue

## التعريف
- الاسم: Continue
- المعرّف: imported-infrastructure-continue
- النوع: external_agent_framework
- المصدر: https://github.com/continuedev/continue
- التصنيف الأصلي: وكلاء برمجيين وتطوير
- المكان المخصص: states/infrastructure
- التخصص الدقيق: ide-assistant
