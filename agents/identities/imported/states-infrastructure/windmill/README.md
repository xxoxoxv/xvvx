# Windmill — مواطن مستورد (windmill)

## التعريف
`Windmill` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-windmill` من مصدره [https://github.com/windmill-labs/windmill](https://github.com/windmill-labs/windmill)، وصُنِّف أصلًا في
