# هوية الوكيل المستورد: Mermaid

## التعريف
- الاسم: Mermaid
- المعرّف: imported-infrastructure-mermaid
- النوع: external_agent_framework
- المصدر: https://github.com/mermaid-js/mermaid
- التصنيف الأصلي: وكلاء برمجيين وتطوير
- المكان المخصص: states/infrastructure
- التخصص الدقيق: diagram-generation
