# Mermaid — مواطن مستورد (mermaid)

## التعريف
`Mermaid` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-mermaid` من مصدره [https://github.com/mermaid-js/mermaid](https://github.com/mermaid-js/mermaid)، وصُنِّف أصلًا في
«وكلاء برمجيين وتطوير»، وأُسكِن في مجال `states-infrastructure`،
وتخصصه الدقيق **diagram-generation**، وخُصِّص له المكان
