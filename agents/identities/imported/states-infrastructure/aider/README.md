# Aider — مواطن مستورد (aider)

## التعريف
`Aider` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-aider` من مصدره [https://github.com/paul-gauthier/aider](https://github.com/paul-gauthier/aider)، وصُنِّف أصلًا في
