# Browser-Use — مواطن مستورد (browser-use)

## التعريف
`Browser-Use` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-browser-use` من مصدره [https://github.com/browser-use/browser-use](https://github.com/browser-use/browser-use)، وصُنِّف أصلًا في
