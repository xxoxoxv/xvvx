# bumpgen — مواطن مستورد (bumpgen)

## التعريف
`bumpgen` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-bumpgen` من مصدره [https://github.com/bumpgen/bumpgen](https://github.com/bumpgen/bumpgen)، وصُنِّف أصلًا في
«وكلاء برمجيين وتطوير»، وأُسكِن في مجال `states-infrastructure`،
وتخصصه الدقيق **dependency-upgrade**، وخُصِّص له المكان
