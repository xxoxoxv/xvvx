# هوية الوكيل المستورد: bumpgen

## التعريف
- الاسم: bumpgen
- المعرّف: imported-infrastructure-bumpgen
- النوع: external_agent_framework
- المصدر: https://github.com/bumpgen/bumpgen
- التصنيف الأصلي: وكلاء برمجيين وتطوير
- المكان المخصص: states/infrastructure
- التخصص الدقيق: dependency-upgrade
