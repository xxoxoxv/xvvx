# OpenSRE — مواطن مستورد (opensre)

## التعريف
`OpenSRE` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-opensre` من مصدره [https://github.com/opensre/opensre](https://github.com/opensre/opensre)، وصُنِّف أصلًا في
«وكلاء DevOps والسحابة»، وأُسكِن في مجال `states-infrastructure`،
وتخصصه الدقيق **sre**، وخُصِّص له المكان
