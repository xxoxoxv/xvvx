# Skyvern — مواطن مستورد (skyvern)

## التعريف
`Skyvern` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-skyvern` من مصدره [https://github.com/Skyvern-AI/skyvern](https://github.com/Skyvern-AI/skyvern)، وصُنِّف أصلًا في
