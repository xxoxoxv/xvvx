# StackStorm (workflow) — مواطن مستورد (stackstorm)

## التعريف
`StackStorm (workflow)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-stackstorm-2` من مصدره [https://github.com/StackStorm/stax](https://github.com/StackStorm/stax)، وصُنِّف أصلًا في
