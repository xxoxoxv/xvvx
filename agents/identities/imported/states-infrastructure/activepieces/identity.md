# هوية الوكيل المستورد: Activepieces (workflow)

## التعريف
- الاسم: Activepieces (workflow)
- المعرّف: imported-infrastructure-activepieces-2
- النوع: external_agent_framework
- المصدر: https://github.com/activepieces/activepieces
- التصنيف الأصلي: وكلاء أتمتة سير العمل
- المكان المخصص: states/infrastructure
- التخصص الدقيق: workflow-automation
