# AutoAgent — مواطن مستورد (autoagent)

## التعريف
`AutoAgent` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-autoagent` من مصدره [https://github.com/AI-OpenAuto/AutoAgent](https://github.com/AI-OpenAuto/AutoAgent)، وصُنِّف أصلًا في
