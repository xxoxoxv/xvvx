# Automata — مواطن مستورد (automata)

## التعريف
`Automata` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-automata` من مصدره [https://github.com/emrgnt-cmplxty/automata](https://github.com/emrgnt-cmplxty/automata)، وصُنِّف أصلًا في
