# Bloop — مواطن مستورد (bloop)

## التعريف
`Bloop` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-bloop` من مصدره [https://github.com/BloopAI/bloop](https://github.com/BloopAI/bloop)، وصُنِّف أصلًا في
«وكلاء برمجيين وتطوير»، وأُسكِن في مجال `states-infrastructure`،
وتخصصه الدقيق **code-search**، وخُصِّص له المكان
