# OpenAgents — مواطن مستورد (openagents)

## التعريف
`OpenAgents` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-openagents` من مصدره [https://github.com/xlang-ai/OpenAgents](https://github.com/xlang-ai/OpenAgents)، وصُنِّف أصلًا في
