# هوية الوكيل المستورد: UI-TARS-desktop

## التعريف
- الاسم: UI-TARS-desktop
- المعرّف: imported-infrastructure-ui-tars-desktop
- النوع: external_agent_framework
- المصدر: https://github.com/bytedance/UI-TARS-desktop
- التصنيف الأصلي: وكلاء تصفح وأتمتة
- المكان المخصص: states/infrastructure
- التخصص الدقيق: gui-automation
