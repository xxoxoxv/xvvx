# هوية الوكيل المستورد: screenshot-to-code

## التعريف
- الاسم: screenshot-to-code
- المعرّف: imported-infrastructure-screenshot-to-code
- النوع: external_agent_framework
- المصدر: https://github.com/abi/screenshot-to-code
- التصنيف الأصلي: وكلاء برمجيين وتطوير
- المكان المخصص: states/infrastructure
- التخصص الدقيق: ui-coding
