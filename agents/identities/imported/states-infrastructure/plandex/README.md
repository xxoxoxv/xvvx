# plandex — مواطن مستورد (plandex)

## التعريف
`plandex` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-plandex` من مصدره [https://github.com/plandex-ai/plandex](https://github.com/plandex-ai/plandex)، وصُنِّف أصلًا في
