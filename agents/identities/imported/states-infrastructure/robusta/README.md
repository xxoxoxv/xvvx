# Robusta (devops) — مواطن مستورد (robusta)

## التعريف
`Robusta (devops)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-robusta-2` من مصدره [https://github.com/robusta-dev/robusta](https://github.com/robusta-dev/robusta)، وصُنِّف أصلًا في
