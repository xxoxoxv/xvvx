# GPT Pilot — مواطن مستورد (gpt-pilot)

## التعريف
`GPT Pilot` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-gpt-pilot` من مصدره [https://github.com/Pythagora-io/gpt-pilot](https://github.com/Pythagora-io/gpt-pilot)، وصُنِّف أصلًا في
