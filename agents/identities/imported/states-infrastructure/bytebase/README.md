# Bytebase (workflow) — مواطن مستورد (bytebase)

## التعريف
`Bytebase (workflow)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-bytebase-2` من مصدره [https://github.com/bytebase/bytebase](https://github.com/bytebase/bytebase)، وصُنِّف أصلًا في
«وكلاء أتمتة سير العمل»، وأُسكِن في مجال `states-infrastructure`،
وتخصصه الدقيق **database-management**، وخُصِّص له المكان
