# هوية الوكيل المستورد: Bytebase (workflow)

## التعريف
- الاسم: Bytebase (workflow)
- المعرّف: imported-infrastructure-bytebase-2
- النوع: external_agent_framework
- المصدر: https://github.com/bytebase/bytebase
- التصنيف الأصلي: وكلاء أتمتة سير العمل
- المكان المخصص: states/infrastructure
- التخصص الدقيق: database-management
