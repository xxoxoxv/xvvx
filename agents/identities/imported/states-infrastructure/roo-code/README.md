# Roo-Code — مواطن مستورد (roo-code)

## التعريف
`Roo-Code` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-roo-code` من مصدره [https://github.com/RooVetGit/Roo-Code](https://github.com/RooVetGit/Roo-Code)، وصُنِّف أصلًا في
