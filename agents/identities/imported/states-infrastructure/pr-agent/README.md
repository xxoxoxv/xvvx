# PR-Agent — مواطن مستورد (pr-agent)

## التعريف
`PR-Agent` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-pr-agent` من مصدره [https://github.com/Codium-ai/pr-agent](https://github.com/Codium-ai/pr-agent)، وصُنِّف أصلًا في
«وكلاء برمجيين وتطوير»، وأُسكِن في مجال `states-infrastructure`،
وتخصصه الدقيق **pr-review**، وخُصِّص له المكان
