# هوية الوكيل المستورد: AgenticSeek

## التعريف
- الاسم: AgenticSeek
- المعرّف: imported-infrastructure-agenticseek
- النوع: external_agent_framework
- المصدر: https://github.com/agenticseek/agenticseek
- التصنيف الأصلي: وكلاء تصفح وأتمتة
- المكان المخصص: states/infrastructure
- التخصص الدقيق: search-automation
