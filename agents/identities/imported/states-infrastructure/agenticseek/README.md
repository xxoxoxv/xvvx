# AgenticSeek — مواطن مستورد (agenticseek)

## التعريف
`AgenticSeek` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-agenticseek` من مصدره [https://github.com/agenticseek/agenticseek](https://github.com/agenticseek/agenticseek)، وصُنِّف أصلًا في
«وكلاء تصفح وأتمتة»، وأُسكِن في مجال `states-infrastructure`،
وتخصصه الدقيق **search-automation**، وخُصِّص له المكان
