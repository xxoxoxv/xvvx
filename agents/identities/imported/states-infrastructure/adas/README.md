# ADAS — مواطن مستورد (adas)

## التعريف
`ADAS` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-adas` من مصدره [https://github.com/ADAS-AI/ADAS](https://github.com/ADAS-AI/ADAS)، وصُنِّف أصلًا في
