# AppAgent (Tencent) — مواطن مستورد (appagent)

## التعريف
`AppAgent (Tencent)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-appagent` من مصدره [https://github.com/AppAgent/AppAgent](https://github.com/AppAgent/AppAgent)، وصُنِّف أصلًا في
