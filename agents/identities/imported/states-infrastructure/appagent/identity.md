# هوية الوكيل المستورد: AppAgent (Tencent)

## التعريف
- الاسم: AppAgent (Tencent)
- المعرّف: imported-infrastructure-appagent
- النوع: external_agent_framework
- المصدر: https://github.com/AppAgent/AppAgent
- التصنيف الأصلي: وكلاء أتمتة الأجهزة المحمولة
- المكان المخصص: states/infrastructure
- التخصص الدقيق: mobile-automation
