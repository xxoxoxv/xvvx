# K8sGPT (devops) — مواطن مستورد (k8sgpt)

## التعريف
`K8sGPT (devops)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-k8sgpt-2` من مصدره [https://github.com/k8sgpt-ai/k8sgpt](https://github.com/k8sgpt-ai/k8sgpt)، وصُنِّف أصلًا في
«وكلاء DevOps والسحابة»، وأُسكِن في مجال `states-infrastructure`،
وتخصصه الدقيق **kubernetes**، وخُصِّص له المكان
