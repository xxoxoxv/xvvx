# هوية الوكيل المستورد: Open Interpreter

## التعريف
- الاسم: Open Interpreter
- المعرّف: imported-infrastructure-open-interpreter
- النوع: external_agent_framework
- المصدر: https://github.com/OpenInterpreter/open-interpreter
- التصنيف الأصلي: وكلاء برمجيين وتطوير
- المكان المخصص: states/infrastructure
- التخصص الدقيق: coding
