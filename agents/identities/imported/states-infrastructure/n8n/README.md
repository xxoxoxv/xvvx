# n8n (workflow) — مواطن مستورد (n8n)

## التعريف
`n8n (workflow)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-n8n-2` من مصدره [https://github.com/n8n-io/n8n](https://github.com/n8n-io/n8n)، وصُنِّف أصلًا في
