# kwaak — مواطن مستورد (kwaak)

## التعريف
`kwaak` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-kwaak` من مصدره [https://github.com/kwaak-ai/kwaak](https://github.com/kwaak-ai/kwaak)، وصُنِّف أصلًا في
