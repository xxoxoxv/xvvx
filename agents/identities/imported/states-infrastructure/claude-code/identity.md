# هوية الوكيل المستورد: Claude Code (Anthropic)

## التعريف
- الاسم: Claude Code (Anthropic)
- المعرّف: imported-infrastructure-claude-code
- النوع: external_agent_framework
- المصدر: https://github.com/anthropics/claude-code
- التصنيف الأصلي: وكلاء برمجيين وتطوير
- المكان المخصص: states/infrastructure
- التخصص الدقيق: cli-coding
