# Goose (Block) — مواطن مستورد (goose)

## التعريف
`Goose (Block)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-goose` من مصدره [https://github.com/block/goose](https://github.com/block/goose)، وصُنِّف أصلًا في
