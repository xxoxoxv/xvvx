# DroidBot — مواطن مستورد (droidbot)

## التعريف
`DroidBot` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-droidbot` من مصدره [https://github.com/honeynet/droidbot](https://github.com/honeynet/droidbot)، وصُنِّف أصلًا في
