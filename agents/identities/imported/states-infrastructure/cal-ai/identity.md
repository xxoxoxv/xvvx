# هوية الوكيل المستورد: Cal.ai

## التعريف
- الاسم: Cal.ai
- المعرّف: imported-infrastructure-cal-ai
- النوع: external_agent_framework
- المصدر: https://github.com/calcom/cal.ai
- التصنيف الأصلي: وكلاء تصفح وأتمتة
- المكان المخصص: states/infrastructure
- التخصص الدقيق: scheduling-automation
