# Cal.ai — مواطن مستورد (cal-ai)

## التعريف
`Cal.ai` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-cal-ai` من مصدره [https://github.com/calcom/cal.ai](https://github.com/calcom/cal.ai)، وصُنِّف أصلًا في
«وكلاء تصفح وأتمتة»، وأُسكِن في مجال `states-infrastructure`،
وتخصصه الدقيق **scheduling-automation**، وخُصِّص له المكان
