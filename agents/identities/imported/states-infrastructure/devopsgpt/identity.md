# هوية الوكيل المستورد: DevOpsGPT

## التعريف
- الاسم: DevOpsGPT
- المعرّف: imported-infrastructure-devopsgpt
- النوع: external_agent_framework
- المصدر: https://github.com/kuafuai/DevOpsGPT
- التصنيف الأصلي: وكلاء برمجيين وتطوير
- المكان المخصص: states/infrastructure
- التخصص الدقيق: devops-automation
