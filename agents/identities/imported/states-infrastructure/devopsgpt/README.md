# DevOpsGPT — مواطن مستورد (devopsgpt)

## التعريف
`DevOpsGPT` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-infrastructure-devopsgpt` من مصدره [https://github.com/kuafuai/DevOpsGPT](https://github.com/kuafuai/DevOpsGPT)، وصُنِّف أصلًا في
«وكلاء برمجيين وتطوير»، وأُسكِن في مجال `states-infrastructure`،
وتخصصه الدقيق **devops-automation**، وخُصِّص له المكان
