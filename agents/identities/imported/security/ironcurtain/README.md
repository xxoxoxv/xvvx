# IronCurtain — مواطن مستورد (ironcurtain)

## التعريف
`IronCurtain` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-security-ironcurtain` من مصدره [https://github.com/ironcurtain/ironcurtain](https://github.com/ironcurtain/ironcurtain)، وصُنِّف أصلًا في
«أمان وحوكمة»، وأُسكِن في مجال `security`،
وتخصصه الدقيق **security**، وخُصِّص له المكان
