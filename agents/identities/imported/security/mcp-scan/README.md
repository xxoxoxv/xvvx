# mcp-scan — مواطن مستورد (mcp-scan)

## التعريف
`mcp-scan` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-security-mcp-scan` من مصدره [https://github.com/mcp-scan/mcp-scan](https://github.com/mcp-scan/mcp-scan)، وصُنِّف أصلًا في
«أمان وحوكمة»، وأُسكِن في مجال `security`،
وتخصصه الدقيق **security-scanning**، وخُصِّص له المكان
