# هوية الوكيل المستورد: mcp-scan

## التعريف
- الاسم: mcp-scan
- المعرّف: imported-security-mcp-scan
- النوع: external_agent_framework
- المصدر: https://github.com/mcp-scan/mcp-scan
- التصنيف الأصلي: أمان وحوكمة
- المكان المخصص: security
- التخصص الدقيق: security-scanning
