# Cilium — مواطن مستورد (cilium)

## التعريف
`Cilium` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-security-cilium` من مصدره [https://github.com/cilium/cilium](https://github.com/cilium/cilium)، وصُنِّف أصلًا في
«أمان وحوكمة»، وأُسكِن في مجال `security`،
وتخصصه الدقيق **network-security**، وخُصِّص له المكان
