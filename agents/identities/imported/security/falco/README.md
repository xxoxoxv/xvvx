# Falco — مواطن مستورد (falco)

## التعريف
`Falco` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-security-falco` من مصدره [https://github.com/falcosecurity/falco](https://github.com/falcosecurity/falco)، وصُنِّف أصلًا في
«أمان وحوكمة»، وأُسكِن في مجال `security`،
وتخصصه الدقيق **runtime-security**، وخُصِّص له المكان
