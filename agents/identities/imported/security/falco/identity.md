# هوية الوكيل المستورد: Falco

## التعريف
- الاسم: Falco
- المعرّف: imported-security-falco
- النوع: external_agent_framework
- المصدر: https://github.com/falcosecurity/falco
- التصنيف الأصلي: أمان وحوكمة
- المكان المخصص: security
- التخصص الدقيق: runtime-security
