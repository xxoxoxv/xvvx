# Agentic Security — مواطن مستورد (agentic-security)

## التعريف
`Agentic Security` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-security-agentic-security` من مصدره [https://github.com/agentic-security/agentic-security](https://github.com/agentic-security/agentic-security)، وصُنِّف أصلًا في
«أمان وحوكمة»، وأُسكِن في مجال `security`،
وتخصصه الدقيق **security-testing**، وخُصِّص له المكان
