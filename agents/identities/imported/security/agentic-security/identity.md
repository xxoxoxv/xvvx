# هوية الوكيل المستورد: Agentic Security

## التعريف
- الاسم: Agentic Security
- المعرّف: imported-security-agentic-security
- النوع: external_agent_framework
- المصدر: https://github.com/agentic-security/agentic-security
- التصنيف الأصلي: أمان وحوكمة
- المكان المخصص: security
- التخصص الدقيق: security-testing
