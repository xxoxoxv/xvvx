# هوية الوكيل المستورد: Sandbox Runtime (Anthropic)

## التعريف
- الاسم: Sandbox Runtime (Anthropic)
- المعرّف: imported-security-sandbox-runtime
- النوع: external_agent_framework
- المصدر: https://github.com/anthropics/sandbox-runtime
- التصنيف الأصلي: أمان وحوكمة
- المكان المخصص: security
- التخصص الدقيق: sandbox-runtime
