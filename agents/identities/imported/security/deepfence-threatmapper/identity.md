# هوية الوكيل المستورد: Deepfence-ThreatMapper

## التعريف
- الاسم: Deepfence-ThreatMapper
- المعرّف: imported-security-deepfence-threatmapper
- النوع: external_agent_framework
- المصدر: https://github.com/deepfence/ThreatMapper
- التصنيف الأصلي: أمان وحوكمة
- المكان المخصص: security
- التخصص الدقيق: threat-mapping
