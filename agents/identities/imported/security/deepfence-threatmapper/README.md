# Deepfence-ThreatMapper — مواطن مستورد (deepfence-threatmapper)

## التعريف
`Deepfence-ThreatMapper` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-security-deepfence-threatmapper` من مصدره [https://github.com/deepfence/ThreatMapper](https://github.com/deepfence/ThreatMapper)، وصُنِّف أصلًا في
«أمان وحوكمة»، وأُسكِن في مجال `security`،
وتخصصه الدقيق **threat-mapping**، وخُصِّص له المكان
