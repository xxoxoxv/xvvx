# هوية الوكيل المستورد: Filesystem MCP

## التعريف
- الاسم: Filesystem MCP
- المعرّف: imported-tools-filesystem-mcp
- النوع: external_agent_framework
- المصدر: https://github.com/modelcontextprotocol/filesystem-mcp
