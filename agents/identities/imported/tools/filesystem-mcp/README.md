# Filesystem MCP — مواطن مستورد (filesystem-mcp)

## التعريف
`Filesystem MCP` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-filesystem-mcp` من مصدره [https://github.com/modelcontextprotocol/filesystem-mcp](https://github.com/modelcontextprotocol/filesystem-mcp)، وصُنِّف أصلًا في
