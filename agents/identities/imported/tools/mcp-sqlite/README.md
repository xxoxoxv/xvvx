# MCP-SQLite — مواطن مستورد (mcp-sqlite)

## التعريف
`MCP-SQLite` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-mcp-sqlite` من مصدره [https://github.com/modelcontextprotocol/sqlite-mcp](https://github.com/modelcontextprotocol/sqlite-mcp)، وصُنِّف أصلًا في
