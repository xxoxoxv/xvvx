# هوية الوكيل المستورد: Claude Desktop Intelligence

## التعريف
- الاسم: Claude Desktop Intelligence
- المعرّف: imported-tools-claude-desktop-intelligence
- النوع: external_agent_framework
- المصدر: https://github.com/claude-desktop-intelligence/claude-desktop-intelligence
- التصنيف الأصلي: أدوات وبنى تحتية أخرى
- المكان المخصص: tools
- التخصص الدقيق: desktop-intelligence
