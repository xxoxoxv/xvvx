# MCP-Git — مواطن مستورد (mcp-git)

## التعريف
`MCP-Git` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-mcp-git` من مصدره [https://github.com/modelcontextprotocol/git-mcp](https://github.com/modelcontextprotocol/git-mcp)، وصُنِّف أصلًا في
