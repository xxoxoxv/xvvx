# NanoClaw — مواطن مستورد (nanoclaw)

## التعريف
`NanoClaw` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-nanoclaw` من مصدره [https://github.com/nanoclaw/nanoclaw](https://github.com/nanoclaw/nanoclaw)، وصُنِّف أصلًا في
