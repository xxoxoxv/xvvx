# Omnigent — مواطن مستورد (omnigent)

## التعريف
`Omnigent` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-omnigent` من مصدره [https://github.com/omnigent/omnigent](https://github.com/omnigent/omnigent)، وصُنِّف أصلًا في
