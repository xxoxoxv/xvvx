# GitHub MCP — مواطن مستورد (github-mcp)

## التعريف
`GitHub MCP` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-github-mcp` من مصدره [https://github.com/github/github-mcp](https://github.com/github/github-mcp)، وصُنِّف أصلًا في
