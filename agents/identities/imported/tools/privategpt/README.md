# PrivateGPT — مواطن مستورد (privategpt)

## التعريف
`PrivateGPT` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-privategpt` من مصدره [https://github.com/zylon-ai/private-gpt](https://github.com/zylon-ai/private-gpt)، وصُنِّف أصلًا في
