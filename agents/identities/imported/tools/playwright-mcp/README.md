# Playwright MCP — مواطن مستورد (playwright-mcp)

## التعريف
`Playwright MCP` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-playwright-mcp` من مصدره [https://github.com/microsoft/playwright-mcp](https://github.com/microsoft/playwright-mcp)، وصُنِّف أصلًا في
