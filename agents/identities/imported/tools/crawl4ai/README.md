# Crawl4AI — مواطن مستورد (crawl4ai)

## التعريف
`Crawl4AI` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-crawl4ai` من مصدره [https://github.com/unclecode/crawl4ai](https://github.com/unclecode/crawl4ai)، وصُنِّف أصلًا في
