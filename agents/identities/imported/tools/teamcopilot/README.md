# teamcopilot — مواطن مستورد (teamcopilot)

## التعريف
`teamcopilot` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-teamcopilot` من مصدره [https://github.com/teamcopilot/teamcopilot](https://github.com/teamcopilot/teamcopilot)، وصُنِّف أصلًا في
«أدوات وبنى تحتية أخرى»، وأُسكِن في مجال `tools`،
وتخصصه الدقيق **team-assistant**، وخُصِّص له المكان
