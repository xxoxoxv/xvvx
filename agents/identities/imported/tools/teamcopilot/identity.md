# هوية الوكيل المستورد: teamcopilot

## التعريف
- الاسم: teamcopilot
- المعرّف: imported-tools-teamcopilot
- النوع: external_agent_framework
- المصدر: https://github.com/teamcopilot/teamcopilot
- التصنيف الأصلي: أدوات وبنى تحتية أخرى
- المكان المخصص: tools
- التخصص الدقيق: team-assistant
