# ZeroClaw — مواطن مستورد (zeroclaw)

## التعريف
`ZeroClaw` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-zeroclaw` من مصدره [https://github.com/zeroclaw/zeroclaw](https://github.com/zeroclaw/zeroclaw)، وصُنِّف أصلًا في
