# Brave Search MCP — مواطن مستورد (brave-search-mcp)

## التعريف
`Brave Search MCP` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-brave-search-mcp` من مصدره [https://github.com/modelcontextprotocol/brave-search-mcp](https://github.com/modelcontextprotocol/brave-search-mcp)، وصُنِّف أصلًا في
«خوادم MCP وتكاملات»، وأُسكِن في مجال `tools`،
وتخصصه الدقيق **mcp-server**، وخُصِّص له المكان
