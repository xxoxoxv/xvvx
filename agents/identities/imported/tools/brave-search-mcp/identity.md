# هوية الوكيل المستورد: Brave Search MCP

## التعريف
- الاسم: Brave Search MCP
- المعرّف: imported-tools-brave-search-mcp
- النوع: external_agent_framework
- المصدر: https://github.com/modelcontextprotocol/brave-search-mcp
