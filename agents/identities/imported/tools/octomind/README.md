# Octomind — مواطن مستورد (octomind)

## التعريف
`Octomind` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-octomind` من مصدره [https://github.com/octomind/octomind](https://github.com/octomind/octomind)، وصُنِّف أصلًا في
«أدوات وبنى تحتية أخرى»، وأُسكِن في مجال `tools`،
وتخصصه الدقيق **testing**، وخُصِّص له المكان
