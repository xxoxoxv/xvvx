# NemoClaw (NVIDIA) — مواطن مستورد (nemoclaw)

## التعريف
`NemoClaw (NVIDIA)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-nemoclaw` من مصدره [https://github.com/nvidia/nemoclaw](https://github.com/nvidia/nemoclaw)، وصُنِّف أصلًا في
