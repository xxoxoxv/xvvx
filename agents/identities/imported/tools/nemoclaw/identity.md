# هوية الوكيل المستورد: NemoClaw (NVIDIA)

## التعريف
- الاسم: NemoClaw (NVIDIA)
- المعرّف: imported-tools-nemoclaw
- النوع: external_agent_framework
- المصدر: https://github.com/nvidia/nemoclaw
- التصنيف الأصلي: أدوات وبنى تحتية أخرى
- المكان المخصص: tools
- التخصص الدقيق: agent-tool
