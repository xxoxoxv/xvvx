# MCP-Puppeteer — مواطن مستورد (mcp-puppeteer)

## التعريف
`MCP-Puppeteer` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-mcp-puppeteer` من مصدره [https://github.com/modelcontextprotocol/puppeteer-mcp](https://github.com/modelcontextprotocol/puppeteer-mcp)، وصُنِّف أصلًا في
