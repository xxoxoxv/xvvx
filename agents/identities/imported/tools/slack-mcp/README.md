# Slack MCP — مواطن مستورد (slack-mcp)

## التعريف
`Slack MCP` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-slack-mcp` من مصدره [https://github.com/modelcontextprotocol/slack-mcp](https://github.com/modelcontextprotocol/slack-mcp)، وصُنِّف أصلًا في
