# Taskade MCP — مواطن مستورد (taskade-mcp)

## التعريف
`Taskade MCP` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-taskade-mcp` من مصدره [https://github.com/taskade/taskade-mcp](https://github.com/taskade/taskade-mcp)، وصُنِّف أصلًا في
