# MCP-Memory — مواطن مستورد (mcp-memory)

## التعريف
`MCP-Memory` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-mcp-memory` من مصدره [https://github.com/modelcontextprotocol/memory-mcp](https://github.com/modelcontextprotocol/memory-mcp)، وصُنِّف أصلًا في
