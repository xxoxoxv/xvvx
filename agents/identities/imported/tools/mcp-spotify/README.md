# MCP-Spotify — مواطن مستورد (mcp-spotify)

## التعريف
`MCP-Spotify` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-mcp-spotify` من مصدره [https://github.com/modelcontextprotocol/spotify-mcp](https://github.com/modelcontextprotocol/spotify-mcp)، وصُنِّف أصلًا في
