# MCP-Search — مواطن مستورد (mcp-search)

## التعريف
`MCP-Search` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-mcp-search` من مصدره [https://github.com/modelcontextprotocol/search-mcp](https://github.com/modelcontextprotocol/search-mcp)، وصُنِّف أصلًا في
