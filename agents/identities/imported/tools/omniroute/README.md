# OmniRoute — مواطن مستورد (omniroute)

## التعريف
`OmniRoute` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-omniroute` من مصدره [https://github.com/omniroute/omniroute](https://github.com/omniroute/omniroute)، وصُنِّف أصلًا في
«أدوات وبنى تحتية أخرى»، وأُسكِن في مجال `tools`،
وتخصصه الدقيق **routing**، وخُصِّص له المكان
