# PostgreSQL MCP — مواطن مستورد (postgresql-mcp)

## التعريف
`PostgreSQL MCP` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-postgresql-mcp` من مصدره [https://github.com/modelcontextprotocol/postgresql-mcp](https://github.com/modelcontextprotocol/postgresql-mcp)، وصُنِّف أصلًا في
