# هوية الوكيل المستورد: PostgreSQL MCP

## التعريف
- الاسم: PostgreSQL MCP
- المعرّف: imported-tools-postgresql-mcp
- النوع: external_agent_framework
- المصدر: https://github.com/modelcontextprotocol/postgresql-mcp
