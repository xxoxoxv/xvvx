# MCP-Fetch — مواطن مستورد (mcp-fetch)

## التعريف
`MCP-Fetch` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-mcp-fetch` من مصدره [https://github.com/modelcontextprotocol/fetch-mcp](https://github.com/modelcontextprotocol/fetch-mcp)، وصُنِّف أصلًا في
