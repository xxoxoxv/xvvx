# clawagents — مواطن مستورد (clawagents)

## التعريف
`clawagents` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-clawagents` من مصدره [https://github.com/clawagents/clawagents](https://github.com/clawagents/clawagents)، وصُنِّف أصلًا في
