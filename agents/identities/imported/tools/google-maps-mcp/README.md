# Google Maps MCP — مواطن مستورد (google-maps-mcp)

## التعريف
`Google Maps MCP` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-google-maps-mcp` من مصدره [https://github.com/modelcontextprotocol/google-maps-mcp](https://github.com/modelcontextprotocol/google-maps-mcp)، وصُنِّف أصلًا في
