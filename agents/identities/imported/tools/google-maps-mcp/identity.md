# هوية الوكيل المستورد: Google Maps MCP

## التعريف
- الاسم: Google Maps MCP
- المعرّف: imported-tools-google-maps-mcp
- النوع: external_agent_framework
- المصدر: https://github.com/modelcontextprotocol/google-maps-mcp
