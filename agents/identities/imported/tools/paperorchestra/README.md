# PaperOrchestra — مواطن مستورد (paperorchestra)

## التعريف
`PaperOrchestra` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-paperorchestra` من مصدره [https://github.com/paperorchestra/paperorchestra](https://github.com/paperorchestra/paperorchestra)، وصُنِّف أصلًا في
