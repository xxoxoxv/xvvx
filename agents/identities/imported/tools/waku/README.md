# Waku — مواطن مستورد (waku)

## التعريف
`Waku` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-waku` من مصدره [https://github.com/waku-ai/waku](https://github.com/waku-ai/waku)، وصُنِّف أصلًا في
