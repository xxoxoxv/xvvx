# GenericAgent — مواطن مستورد (genericagent)

## التعريف
`GenericAgent` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-genericagent` من مصدره [https://github.com/lsdefine/GenericAgent](https://github.com/lsdefine/GenericAgent)، وصُنِّف أصلًا في
«أدوات وبنى تحتية أخرى»، وأُسكِن في مجال `tools`،
وتخصصه الدقيق **agent-tool**، وخُصِّص له المكان
