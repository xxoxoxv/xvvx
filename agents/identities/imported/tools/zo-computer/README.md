# Zo Computer — مواطن مستورد (zo-computer)

## التعريف
`Zo Computer` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-zo-computer` من مصدره [https://github.com/zo-computer/zo-computer](https://github.com/zo-computer/zo-computer)، وصُنِّف أصلًا في
«أدوات وبنى تحتية أخرى»، وأُسكِن في مجال `tools`،
وتخصصه الدقيق **computer-use**، وخُصِّص له المكان
