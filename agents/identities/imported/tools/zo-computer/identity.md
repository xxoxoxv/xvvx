# هوية الوكيل المستورد: Zo Computer

## التعريف
- الاسم: Zo Computer
- المعرّف: imported-tools-zo-computer
- النوع: external_agent_framework
- المصدر: https://github.com/zo-computer/zo-computer
- التصنيف الأصلي: أدوات وبنى تحتية أخرى
- المكان المخصص: tools
- التخصص الدقيق: computer-use
