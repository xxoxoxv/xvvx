# Notion MCP — مواطن مستورد (notion-mcp)

## التعريف
`Notion MCP` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-notion-mcp` من مصدره [https://github.com/modelcontextprotocol/notion-mcp](https://github.com/modelcontextprotocol/notion-mcp)، وصُنِّف أصلًا في
