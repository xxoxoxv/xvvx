# Firecrawl — مواطن مستورد (firecrawl)

## التعريف
`Firecrawl` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-firecrawl` من مصدره [https://github.com/mendableai/firecrawl](https://github.com/mendableai/firecrawl)، وصُنِّف أصلًا في
«أدوات وبنى تحتية أخرى»، وأُسكِن في مجال `tools`،
وتخصصه الدقيق **web-scraping**، وخُصِّص له المكان
