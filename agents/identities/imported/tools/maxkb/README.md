# MaxKB — مواطن مستورد (maxkb)

## التعريف
`MaxKB` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-maxkb` من مصدره [https://github.com/1Panel-dev/MaxKB](https://github.com/1Panel-dev/MaxKB)، وصُنِّف أصلًا في
«أدوات وبنى تحتية أخرى»، وأُسكِن في مجال `tools`،
وتخصصه الدقيق **knowledge-base**، وخُصِّص له المكان
