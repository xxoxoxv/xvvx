# MCP-GSheets — مواطن مستورد (mcp-gsheets)

## التعريف
`MCP-GSheets` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-tools-mcp-gsheets` من مصدره [https://github.com/modelcontextprotocol/gsheets-mcp](https://github.com/modelcontextprotocol/gsheets-mcp)، وصُنِّف أصلًا في
