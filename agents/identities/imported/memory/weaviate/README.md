# Weaviate — مواطن مستورد (weaviate)

## التعريف
`Weaviate` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-memory-weaviate` من مصدره [https://github.com/weaviate/weaviate](https://github.com/weaviate/weaviate)، وصُنِّف أصلًا في
«الذاكرة والبيانات»، وأُسكِن في مجال `memory`،
وتخصصه الدقيق **vector-db**، وخُصِّص له المكان
