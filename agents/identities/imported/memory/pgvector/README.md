# pgvector — مواطن مستورد (pgvector)

## التعريف
`pgvector` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-memory-pgvector` من مصدره [https://github.com/pgvector/pgvector](https://github.com/pgvector/pgvector)، وصُنِّف أصلًا في
