# هوية الوكيل المستورد: Vectra

## التعريف
- الاسم: Vectra
- المعرّف: imported-memory-vectra
- النوع: external_agent_framework
- المصدر: https://github.com/StevenWeathers/vectra
- التصنيف الأصلي: الذاكرة والبيانات
- المكان المخصص: memory
- التخصص الدقيق: vector-search
