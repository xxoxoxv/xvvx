# Vald — مواطن مستورد (vald)

## التعريف
`Vald` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-memory-vald` من مصدره [https://github.com/vdaas/vald](https://github.com/vdaas/vald)، وصُنِّف أصلًا في
