# FAISS — مواطن مستورد (faiss)

## التعريف
`FAISS` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-memory-faiss` من مصدره [https://github.com/facebookresearch/faiss](https://github.com/facebookresearch/faiss)، وصُنِّف أصلًا في
