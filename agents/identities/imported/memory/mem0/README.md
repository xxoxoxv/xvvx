# Mem0 — مواطن مستورد (mem0)

## التعريف
`Mem0` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-memory-mem0` من مصدره [https://github.com/mem0ai/mem0](https://github.com/mem0ai/mem0)، وصُنِّف أصلًا في
