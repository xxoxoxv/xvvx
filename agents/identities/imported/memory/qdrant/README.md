# Qdrant — مواطن مستورد (qdrant)

## التعريف
`Qdrant` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-memory-qdrant` من مصدره [https://github.com/qdrant/qdrant](https://github.com/qdrant/qdrant)، وصُنِّف أصلًا في
