# Zep — مواطن مستورد (zep)

## التعريف
`Zep` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-memory-zep` من مصدره [https://github.com/getzep/zep](https://github.com/getzep/zep)، وصُنِّف أصلًا في
