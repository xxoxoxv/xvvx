# MemGPT (Letta) — مواطن مستورد (memgpt)

## التعريف
`MemGPT (Letta)` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-memory-memgpt` من مصدره [https://github.com/letta-ai/letta](https://github.com/letta-ai/letta)، وصُنِّف أصلًا في
«الذاكرة والبيانات»، وأُسكِن في مجال `memory`،
وتخصصه الدقيق **memory**، وخُصِّص له المكان
