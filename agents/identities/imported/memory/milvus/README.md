# Milvus — مواطن مستورد (milvus)

## التعريف
`Milvus` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-memory-milvus` من مصدره [https://github.com/milvus-io/milvus](https://github.com/milvus-io/milvus)، وصُنِّف أصلًا في
