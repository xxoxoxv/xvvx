# Marqo — مواطن مستورد (marqo)

## التعريف
`Marqo` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-memory-marqo` من مصدره [https://github.com/marqo-ai/marqo](https://github.com/marqo-ai/marqo)، وصُنِّف أصلًا في
