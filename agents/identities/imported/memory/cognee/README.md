# Cognee — مواطن مستورد (cognee)

## التعريف
`Cognee` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-memory-cognee` من مصدره [https://github.com/topoteretes/cognee](https://github.com/topoteretes/cognee)، وصُنِّف أصلًا في
