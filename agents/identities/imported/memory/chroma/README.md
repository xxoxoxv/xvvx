# Chroma — مواطن مستورد (chroma)

## التعريف
`Chroma` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-memory-chroma` من مصدره [https://github.com/chroma-core/chroma](https://github.com/chroma-core/chroma)، وصُنِّف أصلًا في
