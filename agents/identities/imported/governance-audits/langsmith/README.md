# LangSmith — مواطن مستورد (langsmith)

## التعريف
`LangSmith` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-governance-audits-langsmith` من مصدره [https://github.com/langchain-ai/langsmith](https://github.com/langchain-ai/langsmith)، وصُنِّف أصلًا في
«أدوات تقييم واختبار»، وأُسكِن في مجال `governance-audits`،
وتخصصه الدقيق **observability**، وخُصِّص له المكان
