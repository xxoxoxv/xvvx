# هوية الوكيل المستورد: LangSmith

## التعريف
- الاسم: LangSmith
- المعرّف: imported-governance-audits-langsmith
- النوع: external_agent_framework
- المصدر: https://github.com/langchain-ai/langsmith
- التصنيف الأصلي: أدوات تقييم واختبار
- المكان المخصص: governance/audits
- التخصص الدقيق: observability
