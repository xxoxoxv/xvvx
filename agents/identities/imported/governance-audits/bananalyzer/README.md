# bananalyzer — مواطن مستورد (bananalyzer)

## التعريف
`bananalyzer` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-governance-audits-bananalyzer` من مصدره [https://github.com/reworkd/bananalyzer](https://github.com/reworkd/bananalyzer)، وصُنِّف أصلًا في
