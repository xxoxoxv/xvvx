# GAIA — مواطن مستورد (gaia)

## التعريف
`GAIA` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-governance-audits-gaia` من مصدره [https://github.com/GAIA-Benchmark/GAIA](https://github.com/GAIA-Benchmark/GAIA)، وصُنِّف أصلًا في
