# SEAL — مواطن مستورد (seal)

## التعريف
`SEAL` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-governance-audits-seal` من مصدره [https://github.com/SEAL-Evaluation/SEAL](https://github.com/SEAL-Evaluation/SEAL)، وصُنِّف أصلًا في
