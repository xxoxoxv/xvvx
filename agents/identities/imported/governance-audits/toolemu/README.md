# ToolEmu — مواطن مستورد (toolemu)

## التعريف
`ToolEmu` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-governance-audits-toolemu` من مصدره [https://github.com/ryokamoi/toolemu](https://github.com/ryokamoi/toolemu)، وصُنِّف أصلًا في
