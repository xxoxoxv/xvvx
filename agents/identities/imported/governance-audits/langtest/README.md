# LangTest — مواطن مستورد (langtest)

## التعريف
`LangTest` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-governance-audits-langtest` من مصدره [https://github.com/JohnSnowLabs/langtest](https://github.com/JohnSnowLabs/langtest)، وصُنِّف أصلًا في
