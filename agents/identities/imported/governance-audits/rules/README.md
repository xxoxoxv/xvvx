# RuLES — مواطن مستورد (rules)

## التعريف
`RuLES` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-governance-audits-rules` من مصدره [https://github.com/RuLES/RuLES](https://github.com/RuLES/RuLES)، وصُنِّف أصلًا في
