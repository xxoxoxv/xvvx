# WebLINX — مواطن مستورد (weblinx)

## التعريف
`WebLINX` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-governance-audits-weblinx` من مصدره [https://github.com/McGill-NLP/WebLINX](https://github.com/McGill-NLP/WebLINX)، وصُنِّف أصلًا في
