# AgentBoard — مواطن مستورد (agentboard)

## التعريف
`AgentBoard` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-governance-audits-agentboard` من مصدره [https://github.com/AgentBoard/AgentBoard](https://github.com/AgentBoard/AgentBoard)، وصُنِّف أصلًا في
