# DeepEval — مواطن مستورد (deepeval)

## التعريف
`DeepEval` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-governance-audits-deepeval` من مصدره [https://github.com/confident-ai/deepeval](https://github.com/confident-ai/deepeval)، وصُنِّف أصلًا في
