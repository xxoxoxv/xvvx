# هوية الوكيل المستورد: CRUD-RAG

## التعريف
- الاسم: CRUD-RAG
- المعرّف: imported-governance-audits-crud-rag
- النوع: external_agent_framework
- المصدر: https://github.com/CRUD-RAG/CRUD-RAG
- التصنيف الأصلي: أدوات تقييم واختبار
- المكان المخصص: governance/audits
- التخصص الدقيق: rag-evaluation
