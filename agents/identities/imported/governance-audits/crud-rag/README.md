# CRUD-RAG — مواطن مستورد (crud-rag)

## التعريف
`CRUD-RAG` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-governance-audits-crud-rag` من مصدره [https://github.com/CRUD-RAG/CRUD-RAG](https://github.com/CRUD-RAG/CRUD-RAG)، وصُنِّف أصلًا في
«أدوات تقييم واختبار»، وأُسكِن في مجال `governance-audits`،
وتخصصه الدقيق **rag-evaluation**، وخُصِّص له المكان
