# AgentEval — مواطن مستورد (agenteval)

## التعريف
`AgentEval` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-governance-audits-agenteval` من مصدره [https://github.com/AgentEval/AgentEval](https://github.com/AgentEval/AgentEval)، وصُنِّف أصلًا في
