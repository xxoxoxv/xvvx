# ClawBench — مواطن مستورد (clawbench)

## التعريف
`ClawBench` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-governance-audits-clawbench` من مصدره [https://github.com/clawbench/clawbench](https://github.com/clawbench/clawbench)، وصُنِّف أصلًا في
