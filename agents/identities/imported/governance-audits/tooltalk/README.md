# ToolTalk — مواطن مستورد (tooltalk)

## التعريف
`ToolTalk` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-governance-audits-tooltalk` من مصدره [https://github.com/ToolTalk/ToolTalk](https://github.com/ToolTalk/ToolTalk)، وصُنِّف أصلًا في
