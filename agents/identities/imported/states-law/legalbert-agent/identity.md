# هوية الوكيل المستورد: LegalBERT-Agent

## التعريف
- الاسم: LegalBERT-Agent
- المعرّف: imported-law-legalbert-agent
- النوع: external_agent_framework
- المصدر: https://github.com/legalbert/legalbert-agent
- التصنيف الأصلي: وكلاء متخصصون (قانون)
- المكان المخصص: states/law
- التخصص الدقيق: legal
