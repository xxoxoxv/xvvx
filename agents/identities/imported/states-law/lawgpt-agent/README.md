# LawGPT-Agent — مواطن مستورد (lawgpt-agent)

## التعريف
`LawGPT-Agent` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-law-lawgpt-agent` من مصدره [https://github.com/LawGPT-Agent/LawGPT-Agent](https://github.com/LawGPT-Agent/LawGPT-Agent)، وصُنِّف أصلًا في
