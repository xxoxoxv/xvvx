# هوية الوكيل المستورد: LM Studio

## التعريف
- الاسم: LM Studio
- المعرّف: imported-models-lm-studio
- النوع: external_agent_framework
- المصدر: https://github.com/lmstudio-ai/lmstudio
- التصنيف الأصلي: أدوات وبنى تحتية أخرى
- المكان المخصص: models
- التخصص الدقيق: local-models
