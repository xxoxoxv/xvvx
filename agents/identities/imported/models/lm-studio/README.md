# LM Studio — مواطن مستورد (lm-studio)

## التعريف
`LM Studio` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-models-lm-studio` من مصدره [https://github.com/lmstudio-ai/lmstudio](https://github.com/lmstudio-ai/lmstudio)، وصُنِّف أصلًا في
«أدوات وبنى تحتية أخرى»، وأُسكِن في مجال `models`،
وتخصصه الدقيق **local-models**، وخُصِّص له المكان
`models` داخل بنية الدولة. لم يُنسخ كود مصدره
