# Ollama — مواطن مستورد (ollama)

## التعريف
`Ollama` مورد خارجي مستورد إلى الفدرالية كـ**موظف مرشَّح** لا كعضو عامل. سُجِّل
تحت المعرّف `imported-models-ollama` من مصدره [https://github.com/ollama/ollama](https://github.com/ollama/ollama)، وصُنِّف أصلًا في
