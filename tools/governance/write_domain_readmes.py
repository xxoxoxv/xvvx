...
SCOPES: dict[str, tuple[str, str]] = {
    ...
    # ── مواصفات وفروع ─────────────────────────────────────────────
    "core/crown": (
        "حماية مصدر السلطة نفسه: مرساة الثقة، وسجل مفاتيح التاج ونسبها، والأمر "
        "الملكي الموقَّع، والخلافة، والاسترداد، والاستمرارية، والحارس السيادي، "
        "وسجل التاج، ونموذج التهديد. لا يدخل هنا مفتاح خاص ولا سرّ إنتاجي، ولا "
        "قرار سيادي يُتَّخذ نيابةً عن الملك.",
        "التاج",
    ),
    "tools/crown": (
        "أدوات إنفاذ سلامة نطاق التاج: التحقق من جذر الثقة، وتوليد مصفوفة حقيقة "
        "النطاق من الدليل المقيس. لا تنفّذ سياسة سيادية ولا تعدّل حالة مفتاح.",
        "التاج",
    ),
    "docs/security": (
        "وثائق حماية التاج: معمار الحماية، ونموذج التهديد المولَّد من التنفيذ، "
        "وحدّ البرمجية والبشر، وخارطة الأمن. توصيف وحدود مُعلَنة، لا ادّعاء أمن مطلق.",
        "التاج",
    ),
    "core/specs": (
