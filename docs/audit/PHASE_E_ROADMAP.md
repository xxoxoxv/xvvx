...
| **E2.1** | Supreme Royal Authority — السلطة الملكية العليا | `PROVEN` | 2026-08-16 | `core/sovereignty/authority.py` + [`AMD-002`](../../core/constitution/amendments/AMD-002-supreme-royal-authority.md) + `tools/sovereignty/prove_supreme_authority.py` | `__E21_COMMIT__` |
| **E3** | Identity Kernel — نواة الهوية | `IN_PROGRESS` — الشقّ **أ** `PROVEN` والشقّ **ب** `DESIGNED` | 2026-08-16 | `tools/governance/check_repository_identity.py` + [`INT-001`](../../core/constitution/interpretations/INT-001-article-009-scope.md) · [`INT-002`](../../core/constitution/interpretations/INT-002-preamble-sealing.md) | `__E3_COMMIT__` |
