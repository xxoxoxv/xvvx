...
FORBIDDEN_KEY_MATERIAL: Final[frozenset[str]] = frozenset(
    {
        ...
        "brain_signal",
        "neural_implant",
        # الوصف الجامع حين يُقرن بالمفتاح. و«biometric_reader» اسم جهاز قارئ
        # مشروع، فلا تُمنع الكلمة وحدها — يُمنع اتخاذها مادةَ مفتاح.
        "biometric_key",
        "biometric_private",
        "biometric_secret",
        "biometric_seed",
        "keystroke_dynamics",
        # المفردات العربية — والمستودع عربيّ أوّلًا. غيابها كان ثغرة فعلية:
        # «بصمة_الإصبع» كانت تمرّ لأن المعجم إنجليزي وحده.
        "بيومتري_مفتاح",
        "بيومترية_مفتاح",
        "قزحية",
        "شبكية",
...
#: كلمة «بصمة» وحدها **ليست** ممنوعة: تعني في هذا المستودع بصمة تجزئة (SHA-256)
#: قبل أن تعني بصمة إصبع. فالمنع مقيَّد بالتركيب الدالّ على العضو.
