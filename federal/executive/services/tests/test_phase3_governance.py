...
class TestAuditHashChain:
    ...
    def test_no_modification(self):
        ...
        from amos_federation.common.persistent import PersistentAuditStore, AuditEntryModel
...
class TestKillSwitch:
    ...
    def test_activate_alert(self):
        ...
        from amos_federation.services.governance.canary import activate_kill_switch, reset_kill_switch
    ...
    def test_reset(self):
        """3.4: إعادة الضبط."""
        from amos_federation.services.governance.canary import activate_kill_switch, reset_kill_switch, get_system_status
    ...
    def test_is_system_halted(self):
        ...
        from amos_federation.services.governance.canary import activate_kill_switch, reset_kill_switch, is_system_halted
        activate_kill_switch("halt", "test", "test")
    ...
    def test_is_execution_blocked_in_halt(self):
        ...
        from amos_federation.services.governance.canary import activate_kill_switch, reset_kill_switch, is_execution_blocked
        activate_kill_switch("halt", "test", "test")
