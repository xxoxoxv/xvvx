...
def _sample_experiences() -> list[dict]:
    ...
    return [
        {"experience_id": "exp-1", "type": "success", "agent_id": "worker-1", "model_used": "alpha",
         "quality_score": 0.9, "created_at": "2026-08-15T10:00:00Z",
         "outcome": {"input": "حلل البيانات", "output": "تم التحليل", "domain": "finance"}},
        {"experience_id": "exp-2", "type": "failure", "agent_id": "worker-2", "model_used": "alpha",
         "quality_score": 0.3, "created_at": "2026-08-15T11:00:00Z",
         "outcome": {"input": "تقرير قانوني", "output": "", "domain": "law"}},
        {"experience_id": "exp-3", "type": "gap", "agent_id": "worker-1", "model_used": "alpha",
         "quality_score": 0.5, "created_at": "2026-08-15T12:00:00Z",
         "outcome": {"input": "تحليل طبي", "output": "ناقص", "domain": "health"}},
        {"experience_id": "exp-4", "type": "success", "agent_id": "worker-3", "model_used": "beta",
         "quality_score": 0.85, "created_at": "2026-08-15T13:00:00Z",
         "outcome": {"input": "حلل البيانات", "output": "تم التحليل", "domain": "finance"}},
    ]
...
def test_api_create_dataset() -> None:
    ...
    resp = client.post("/v1/datasets", headers=AUTH_HEADERS,
...
def test_api_list_datasets() -> None:
    """واجهة عرض البيانات."""
    client.post("/v1/datasets", headers=AUTH_HEADERS,
                json={"experiences": _sample_experiences()})
...
def test_api_get_dataset() -> None:
    ...
    create = client.post("/v1/datasets", headers=AUTH_HEADERS,
                          json={"experiences": _sample_experiences()})
...
def test_api_train_model() -> None:
    """واجهة تدريب LoRA."""
    create_ds = client.post("/v1/datasets", headers=AUTH_HEADERS,
                            json={"experiences": _sample_experiences()})
    dataset_id = create_ds.json()["dataset_id"]
    resp = client.post("/v1/models/train", headers=AUTH_HEADERS,
                       json={"dataset_id": dataset_id, "base_model": "llama-3-8b",
...
def test_api_list_models() -> None:
    ...
    create_ds = client.post("/v1/datasets", headers=AUTH_HEADERS,
                            json={"experiences": _sample_experiences()})
    client.post("/v1/models/train", headers=AUTH_HEADERS,
...
def test_api_get_model() -> None:
    ...
    create_ds = client.post("/v1/datasets", headers=AUTH_HEADERS,
                            json={"experiences": _sample_experiences()})
    train = client.post("/v1/models/train", headers=AUTH_HEADERS,
                        json={"dataset_id": create_ds.json()["dataset_id"]})
...
def test_api_update_model_status() -> None:
    ...
    train = client.post("/v1/models/train", headers=AUTH_HEADERS,
                        json={"dataset_id": create_ds.json()["dataset_id"]})
    model_id = train.json()["model_id"]
    resp = client.patch(f"/v1/models/{model_id}/status", headers=AUTH_HEADERS,
