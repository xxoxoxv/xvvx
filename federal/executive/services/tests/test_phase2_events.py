...
class TestDurableEventBus:
    ...
    def test_replay(self):
        ...
        # replay من البداية
        events = bus.replay(
            consumer_name="replay-test", subject="amos_federation.task.created", from_beginning=True
        )
...
class TestEventWiring:
    ...
    def test_publish_experience_recorded(self):
        ...
        event = publish_experience_recorded(
            "exp-001", "task_completion", "agent-001", "wiring-001", 0.9
        )
