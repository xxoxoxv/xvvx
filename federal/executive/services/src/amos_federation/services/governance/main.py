...
الهدف: توفير هيكل تشغيل واضح لخدمة governance
النطاق: خدمة governance ضمن Sprint الحالي
...
async def not_implemented() -> None:
    ...
    raise HTTPException(
        ...
        detail="وظيفة تقييم السياسات مؤجلة إلى الأسبوع 11-13: Memory + Hardening",
    )


_service = SERVICES["governance"]
app = create_service_app(_service["name"], _service["port"], "تقييم السياسات", [router])
